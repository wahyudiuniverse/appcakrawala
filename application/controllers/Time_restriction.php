...
class Time_restriction extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		if($system[0]->module_recruitment=='true'){
			$data['title'] = 'SERVER TIME RESTRICTION';
			...
			$data['subview'] = $this->load->view("frontend/hrpremium/time_restriction", $data, TRUE);
