...
class register_mata extends MY_Controller {
	...
	public function index() {
		...
		// 	redirect('admin/');
		// }
		// $data['title'] = 'FORM KARYAWAN BARU <br>PT. MATA CAKRAWALA	INDONESIA';
		...
		// $data['all_project'] = $this->Project_model->read_project_posisi_mata();
		// $data['path_url'] = 'register_projects_mata';
		// $data['subview'] = $this->load->view("frontend/hrpremium/register_project_mata", $data, TRUE);
