...
class ceknik extends MY_Controller {
	...
	public function index() {
		...
		$data['subview'] = $this->load->view("frontend/hrpremium/cek_nik", $data, TRUE);
		...
		if($this->input->post('add_type')=='employer') {
			...
			if($this->input->post('nomor_ktp')==='') {
				$Return['error'] = $this->lang->line('xin_employee_error_ktp');
							...
							$result = $this->Employees_model->checknik($this->input->post('nomor_ktp'));
							// if(!is_null($result)){
	...
	public function output($Return=array()){
	 ...
	 public function sign_in() {
		...
		$data['subview'] = $this->load->view("frontend/hrpremium/sign_in", $data, TRUE);
		$this->load->view('frontend/hrpremium/job_layout/job_layout', $data); //page load
     }
	...
	public function forgot_password() {
		...
		$data['subview'] = $this->load->view("frontend/hrpremium/forgot_password", $data, TRUE);
		$this->load->view('frontend/hrpremium/job_layout/job_layout', $data); //page load
     }
	 public function change_password() {
		...
		$data['subview'] = $this->load->view("frontend/hrpremium/change_password", $data, TRUE);
		$this->load->view('frontend/hrpremium/job_layout/job_layout', $data); //page load
     }
	  ...
	  public function post_job() {
		...
		$data['all_job_categories'] = $this->Recruitment_model->all_job_categories();
		$data['subview'] = $this->load->view("frontend/hrpremium/post_job", $data, TRUE);
		$this->load->view('frontend/hrpremium/job_layout/job_layout', $data); //page load
     }
	...
	public function tambah_employee() {
		...
		if($this->input->post('company_name')==='') {
		...
		} else if($this->input->post('pos_id')==='') {
			$Return['error'] = 'Posisi/Jabatan belum dipilih';
			...
			// if(is_uploaded_file($_FILES['company_logo']['tmp_name'])) {
				...
				$password_hash = password_hash($private_code, PASSWORD_BCRYPT, $options);
					...
					'designation_id' => $this->input->post('pos_id'),
	...
	public function edit_job() {
		...
		$data['subview'] = $this->load->view("frontend/hrpremium/edit_job", $data, TRUE);
		$this->load->view('frontend/hrpremium/job_layout/job_layout', $data); //page load
     }
	 ...
	 public function manage_jobs() {
		...
		$data['all_job_categories'] = $this->Recruitment_model->all_job_categories();
		$data['subview'] = $this->load->view("frontend/hrpremium/manage_jobs", $data, TRUE);
		$this->load->view('frontend/hrpremium/job_layout/job_layout', $data); //page load
     }
	 ...
	 public function manage_applications() {
		...
		$data['all_job_categories'] = $this->Recruitment_model->all_job_categories();
		$data['subview'] = $this->load->view("frontend/hrpremium/manage_applications", $data, TRUE);
		$this->load->view('frontend/hrpremium/job_layout/job_layout', $data); //page load
     }
	 ...
	 public function jobs_applications_list() {
		...
		$session = $this->session->userdata('c_user_id');
		if(!empty($session)){ 
			$this->load->view("frontend/hrpremium/manage_applications", $data);
		} else {
			redirect('');
		}
		// Datatables Variables
	 ...
	 public function employer_job_list() {
		...
		$session = $this->session->userdata('c_user_id');
		if(!empty($session)){ 
			$this->load->view("frontend/hrpremium/manage_jobs", $data);
		} else {
			redirect('');
		}
		// Datatables Variables
	...
	public function update_job() {
	 ...
	 public function account() {
		...
		$data['subview'] = $this->load->view("frontend/hrpremium/employer_account", $data, TRUE);
		$this->load->view('frontend/hrpremium/job_layout/job_layout', $data); //page load
     }
