...
class Pkwt301 extends MY_Controller 
{
...
<br>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td>2.</td>
								<td colspan="20">Tidak datang terlambat tanpa alasan yang dapat diterima oleh Perusahaan, tidak meninggalkan tempat kerja tanpa sepengetahuan atasan, tidak mangkir dan sebagainya yang dapat merugikan Perusahaan. Apabila datang terlambat berikut merupakan sanksi keterlambatan sesuai dengan jabatan masing-masing :</td>
							</tr>
<br>
...
<BR><BR><BR>
							...
							<tr>
								<td >13.</td>
								<td colspan="20">Insentif diberikan minimal sebesar Rp. 200.000 apabila tidak memenuhi target dan diberikan sebesar Rp. 500.000 bila memenuhi target yang diberikan berdasarkan penilaian performance dengan ketentuan sebagai berikut:</td>
								<td colspan="0"></td>
							</tr>
							...
							<tr>
								<td ></td>
								<td colspan="0">A.</td>
								<td colspan="20">Kebijakan pemberian Insentif Rp. 500.000</td>
							</tr>

							<tr>
								<td ></td>
								<td colspan="0"></td>
								<td colspan="20">Administrasi Kepegawaian untuk 2 project yang di handle Sasa dan Enesis dengan mencapai 100%.</td>
							</tr>
							...
							<tr>
								...
								<td ></td>
								<td colspan="0">a.</td>
								<td colspan="20">Administrasi Kepegawaian mencakup	:</td>
							</tr>
							...
							<tr>
								...
								<td ></td>
								<td colspan="0"></td>
								<td colspan="20">•	Update Database (Database mencakup kelengkapan data CIS dan <i>softfile database project update</i></td>
							</tr>
							...
							<tr>
								...
								<td ></td>
								<td colspan="0"></td>
								<td colspan="20">•	Feedback BPJS</td>
							</tr>
							...
							<tr>
								...
								<td ></td>
								<td colspan="0">b.</td>
								<td colspan="20">Administrasi non Kepegawaian mencakup	:</td>
							</tr>
							...
							<tr>
								...
								<td ></td>
								<td colspan="0"></td>
								<td colspan="20">•	Update pemenuhan untuk project Sasa setiap hari</td>
							</tr>
							...
							<tr>
								...
								<td ></td>
								<td colspan="0"></td>
								<td colspan="20">•	Pengajuan DLK (Dinas Luar Kota) dan pengecekan BOP tim Sasa</td>
							</tr>
							...
							<tr>
								...
								<td ></td>
								<td colspan="0"></td>
								<td colspan="20">•	Pengembalian gaji sesuai syarat/SOP perusahaan yang diminta oleh client</td>
							</tr>
							...
							<tr>
								...
								<td ></td>
								<td colspan="0"></td>
								<td colspan="20">•	Additional request by NOM sesuai dengan reporting kepegawaian</td>
							</tr>
							...
							<tr>
								...
								<td ></td>
								<td colspan="0"></td>
								<td colspan="20">•	Pengecekan setiap hari BSU (Bukti Setor) motor sasa</td>
							</tr>

							<tr>
								<td ></td>
								<td ></td>
								<td colspan="20">Adapun administrasi diatas dilakukan sesuai timeline yang berlaku dan tidak terlewatkan.</td>
								<td colspan="0"></td>
							</tr>
<br>
							...
							<tr>
								<td ></td>
								<td colspan="0">B.</td>
								<td colspan="20">Kebijakan pemberian Insentif Rp. 200.000.</td>
							</tr>
							...
							<tr>
								...
								<td ></td>
								<td colspan="0">•</td>
								<td colspan="20">Jika administrasi kepegawaian dan administrasi non kepegawaian tidak berjalan sesuai timeline maka nilai insentif yang diberikan sebesar Rp. 200.000</td>
							</tr>
