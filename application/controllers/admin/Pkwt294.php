...
class Pkwt294 extends MY_Controller 
{
				...
				<br>
						...
						$tbl_2 .= '
							...
							<tr>
								<td colspan="0"></td>
								<td colspan="1">•</td>
								<td colspan="20"><b>'.$basicpay.'</b> Upah diberikan sesuai dengan kehadiran 25 Hari Kerja dalam 1 bulan kerja.</td>
							</tr>
							...
							<tr>
								<td>5.</td>
								<td colspan="20">Pihak perusahaan akan mendaftarkan BPJS Ketenagakerjaan untuk Mitra selama bekerja yaitu (JKK dan JKM). Maka atas dasar hal tersebut apabila Karyawan Mitra mengalami sakit disaat jam kerja atau pihak Anggota keluarga karyawan Mitra sakit atau masuk ke Rumah Sakit maka biaya akan menjadi beban pribadi karyawan Mitra dan tidak menjadi beban</td>
							</tr>
