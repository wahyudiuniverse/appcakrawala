...
class Pkwt479 extends MY_Controller 
{
				...
				<br>
						...
						$tbl_2 .= '
							...
							<tr>
								<td colspan="0"></td>
								<td colspan="1">•</td>
								<td colspan="20">Total Upah Bulanan yang didapatkan adalah sebesar <b>'.$basicpay.'</b> dan diberikan sesuai dengan hari kerja '.$waktukerja.' hari dalam 1 bulan.</td>
							</tr>
