			...
			if(in_array($_FILES['file']['type'],$csvMimes)){
				if(is_uploaded_file($_FILES['file']['tmp_name'])){
					...
					while(($line = fgetcsv($csvFile,1000,';')) !== FALSE){
						...
						'deposit' 								=> $line[43],
						'pph' 										=> $line[44],
						'penalty_late' 						=> $line[45],
						'penalty_attend' 					=> $line[46],
						'mix_oplos' 							=> $line[47],
						'pot_trip_malang' 				=> $line[48],
						'pot_device' 							=> $line[49],
						'deduction' 							=> $line[50],
						'simpanan_pokok' 					=> $line[51],
						'simpanan_wajib_koperasi' => $line[52],
						'pembayaran_pinjaman' 		=> $line[53],
						'biaya_admin_bank' 				=> $line[54],
						'adjustment' 							=> $line[55],
						'adjustment_dlk' 					=> $line[56],
						'total' 									=> $line[57],
