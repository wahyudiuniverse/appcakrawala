			...
			if(in_array($_FILES['file']['type'],$csvMimes)){
				if(is_uploaded_file($_FILES['file']['tmp_name'])){
					...
					while(($line = fgetcsv($csvFile,1000,';')) !== FALSE){
						...
						'penyesuaian_umk' 		=> $line[24],
						'insentive'						=> $line[25],
						'overtime' 						=> $line[26],
						'overtime_holiday' 		=> $line[27],
						'overtime_national_day' => $line[28],
						'overtime_rapel' 			=> $line[29],
						'kompensasi' 					=> $line[30],
						'bonus' 							=> $line[31],
						'uuck' 								=> $line[32],
						'thr' 								=> $line[33],
						'bpjs_tk_deduction' 	=> $line[34],
						'bpjs_ks_deduction' 	=> $line[35],
						'jaminan_pensiun_deduction' => $line[36],
						'pendapatan' 					=> $line[37],
						'bpjs_tk' 						=> $line[38],
						'bpjs_ks' 						=> $line[39],
						'jaminan_pensiun' 		=> $line[40],
						'deposit' 						=> $line[41],
						'pph' 								=> $line[42],
						'penalty_late' 				=> $line[43],
						'penalty_attend' 			=> $line[44],
						'mix_oplos' 					=> $line[45],
						'pot_trip_malang' 		=> $line[46],
						'pot_device' 					=> $line[47],
						'deduction' 					=> $line[48],
						'simpanan_pokok' 			=> $line[49],
						'simpanan_wajib_koperasi' => $line[50],
						'pembayaran_pinjaman' => $line[51],
						'biaya_admin_bank' 		=> $line[52],
						'adjustment' 					=> $line[53],
						'adjustment_dlk' 			=> $line[54],
						'total' 							=> $line[55],
