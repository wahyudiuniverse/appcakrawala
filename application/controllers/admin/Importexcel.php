			...
			if(in_array($_FILES['file']['type'],$csvMimes)){
				if(is_uploaded_file($_FILES['file']['tmp_name'])){
					...
					while(($line = fgetcsv($csvFile,1000,';')) !== FALSE){
						...
						'allow_operation' => $line[21],
						'penyesuaian_umk' => $line[22],
						'insentive'	=> $line[23],
						'overtime' => $line[24],
						'overtime_holiday' => $line[25],
						'overtime_national_day' => $line[26],
						'overtime_rapel' => $line[27],
						'kompensasi' => $line[28],
						'bonus' => $line[29],
						'uuck' => $line[30],
						'thr' => $line[31],
						'bpjs_tk_deduction' => $line[32],
						'bpjs_ks_deduction' => $line[33],
						'jaminan_pensiun_deduction' => $line[34],
						'pendapatan' => $line[35],
						'bpjs_tk' => $line[36],
						'bpjs_ks' => $line[37],
						'jaminan_pensiun' => $line[38],
						'deposit' => $line[39],
						'pph' => $line[40],
						'penalty_late' => $line[41],
						'penalty_attend' => $line[42],
						'mix_oplos' => $line[43],
						'deduction' => $line[44],
						'simpanan_pokok' => $line[45],
						'simpanan_wajib_koperasi' => $line[46],
						'pembayaran_pinjaman' => $line[47],
						'biaya_admin_bank' => $line[48],
						'adjustment' => $line[49],
						'adjustment_dlk' => $line[50],
						'total' => $line[51],
