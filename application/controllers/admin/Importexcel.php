			...
			if(in_array($_FILES['file']['type'],$csvMimes)){
				if(is_uploaded_file($_FILES['file']['tmp_name'])){
					...
					while(($line = fgetcsv($csvFile,1000,';')) !== FALSE){
						...
						'allow_vitamin' 					=> $line[23],
						'allow_operation' 				=> $line[24],
						'over_salary' 						=> $line[25],
						'penyesuaian_umk' 				=> $line[26],
						'insentive'								=> $line[27],
						'overtime' 								=> $line[28],
						'overtime_holiday' 				=> $line[29],
						'overtime_national_day' 	=> $line[30],
						'overtime_rapel' 					=> $line[31],
						'kompensasi' 							=> $line[32],
						'bonus' 									=> $line[33],
						'uuck' 										=> $line[34],
						'thr' 										=> $line[35],
						'bpjs_tk_deduction' 			=> $line[36],
						'bpjs_ks_deduction' 			=> $line[37],
						'jaminan_pensiun_deduction' => $line[38],
						'pendapatan' 							=> $line[39],
						'bpjs_tk' 								=> $line[40],
						'bpjs_ks' 								=> $line[41],
						'jaminan_pensiun' 				=> $line[42],
						'deposit' 								=> $line[43],
						'pph' 										=> $line[44],
						'pph_thr' 								=> $line[45],
						'penalty_late' 						=> $line[46],
						'penalty_alfa' 						=> $line[47],
						'penalty_attend' 					=> $line[48],
						'mix_oplos' 							=> $line[49],
						'pot_trip_malang' 				=> $line[50],
						'pot_device' 							=> $line[51],
						'deduction' 							=> $line[52],
						'simpanan_pokok' 					=> $line[53],
						'simpanan_wajib_koperasi' => $line[54],
						'pembayaran_pinjaman' 		=> $line[55],
						'biaya_admin_bank' 				=> $line[56],
						'adjustment' 							=> $line[57],
						'adjustment_dlk' 					=> $line[58],
						'total' 									=> $line[59],
