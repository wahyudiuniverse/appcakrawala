			...
			if(in_array($_FILES['file']['type'],$csvMimes)){
				if(is_uploaded_file($_FILES['file']['tmp_name'])){
					...
					while(($line = fgetcsv($csvFile,1000,';')) !== FALSE){
						...
						'allow_akomodasi' => $line[16],
						'allow_device' => $line[17],
						'allow_kasir' => $line[18],
						'allow_trans_meal' => $line[19],
						'allow_vitamin' => $line[20],
						'penyesuaian_umk' => $line[21],
						'insentive'	=> $line[22],
						'overtime' => $line[23],
						'overtime_holiday' => $line[24],
						'overtime_national_day' => $line[25],
						'overtime_rapel' => $line[26],
						'kompensasi' => $line[27],
						'bonus' => $line[28],
						'thr' => $line[29],
						'bpjs_tk_deduction' => $line[30],
						'bpjs_ks_deduction' => $line[31],
						'jaminan_pensiun_deduction' => $line[32],
						'pendapatan' => $line[33],
						'bpjs_tk' => $line[34],
						'bpjs_ks' => $line[35],
						'jaminan_pensiun' => $line[36],
						'deposit' => $line[37],
						'pph' => $line[38],
						'penalty_late' => $line[39],
						'penalty_attend' => $line[40],
						'mix_oplos' => $line[41],
						'deduction' => $line[42],
						'simpanan_pokok' => $line[43],
						'simpanan_wajib_koperasi' => $line[44],
						'pembayaran_pinjaman' => $line[45],
						'biaya_admin_bank' => $line[46],
						'adjustment' => $line[47],
						'total' => $line[48],
			...
			if(in_array($_FILES['file']['type'],$csvMimes)){
				if(is_uploaded_file($_FILES['file']['tmp_name'])){
					...
					while(($line = fgetcsv($csvFile,1000,';')) !== FALSE){
						...
						'date_periode' 				=> $line[3], //start date
						'project_id' 					=> $line[4], //project id
						'project' 						=> $line[5],//project
						'sub_project_id' 			=> $line[6],//sub project id
						'sub_project' 				=> $line[7], // sub project
						'kota' 								=> $line[8], //kota
						'posisi_jabatan' 			=> $line[9],//jabatan
						'jumlah_mpp' 					=> $line[10],//jumlah mpp
						'gaji_pokok' 					=> $line[11],//gapok
						'hari_kerja' 					=> $line[12],//hari kerja
						'dm_grade' 						=> $line[13], // dm_grade
						'allow_grade' 				=> $line[14],//grade
						'dm_masa_kerja' 			=> $line[15], // dm_grade
						'allow_masa_kerja' 		=> $line[16],//grade
						'dm_konsumsi' 				=> $line[17],//dm_konsumsi
						'allow_konsumsi' 			=> $line[18],//konsumsi
						'dm_transport' 				=> $line[19],//dm_transport
						'allow_transport' 		=> $line[20],//transport
						'dm_rent' 						=> $line[21],//dm_sewa
						'allow_rent' 					=> $line[22],//sewa
						'dm_comunication' 		=> $line[23],
						'allow_comunication'	=> $line[24],
						'dm_parking'					=> $line[25],//dm_parkir
						'allow_parking' 			=> $line[26],//parkir
						'dm_resicance' 				=> $line[27],//dm_residance
						'allow_residance' 		=> $line[28], //allow resicande
						'dm_device' 					=> $line[29],//dm_device
						'allow_device' 				=> $line[30],//device
						'dm_kasir' 						=> $line[31],//dm kasair
						'allow_kasir' 				=> $line[32], //allow kasir
						'dm_trans_meal' 			=> $line[33],//dm_transmeal
						'allow_trans_meal' 		=> $line[34],//transmeal
						'dm_medicine' 				=> $line[35],//dm_medical
						'allow_medicine' 			=> $line[36],//medical
						'total_allow' 				=> $line[37],//total_tunjangan
						'gaji_bersih' 				=> $line[38],//gaji bersih
						'kompensasi' 					=> $line[39],//kompensasi
						'kompensasi_pt' 			=> $line[40],//kompensasi client
						'bpjs_tk' 						=> $line[41],//bpjs tk
						'bpjs_ks' 						=> $line[42],//bpjs ks
						'insentive' 					=> $line[43],//insentive
						'total' 							=> $line[44],//total
						'grand_total' 				=> $line[45],//grand_total
