			...
			if(in_array($_FILES['file']['type'],$csvMimes)){
				if(is_uploaded_file($_FILES['file']['tmp_name'])){
					...
					while(($line = fgetcsv($csvFile,1000,';')) !== FALSE){
						...
						'gaji_umk' 								=> $line[7],
						'gaji_pokok' 							=> $line[8],
						'allow_jabatan' 					=> $line[9],
						'allow_area' 							=> $line[10],
						'allow_masakerja' 				=> $line[11],
						'allow_konsumsi' 					=> $line[12],
						'allow_transport' 				=> $line[13],
						'allow_rent' 							=> $line[14],
						'allow_comunication' 			=> $line[15],
						'allow_parking' 					=> $line[16],
						'allow_residence_cost' 		=> $line[17],
						'allow_akomodasi' 				=> $line[18],
						'allow_device' 						=> $line[19],
						'allow_kasir' 						=> $line[20],
						'allow_trans_meal' 				=> $line[21],
						'allow_vitamin' 					=> $line[22],
						'allow_operation' 				=> $line[23],
						'over_salary' 						=> $line[24],
						'penyesuaian_umk' 				=> $line[25],
						'insentive'								=> $line[26],
						'overtime' 								=> $line[27],
						'overtime_holiday' 				=> $line[28],
						'overtime_national_day' 	=> $line[29],
						'overtime_rapel' 					=> $line[30],
						'kompensasi' 							=> $line[31],
						'bonus' 									=> $line[32],
						'uuck' 										=> $line[33],
						'thr' 										=> $line[34],
						'bpjs_tk_deduction' 			=> $line[35],
						'bpjs_ks_deduction' 			=> $line[36],
						'jaminan_pensiun_deduction' => $line[37],
						'pendapatan' 							=> $line[38],
						'bpjs_tk' 								=> $line[39],
						'bpjs_ks' 								=> $line[40],
						'jaminan_pensiun' 				=> $line[41],
						'deposit' 								=> $line[42],
						'pph' 										=> $line[43],
						'penalty_late' 						=> $line[44],
						'penalty_attend' 					=> $line[45],
						'mix_oplos' 							=> $line[46],
						'pot_trip_malang' 				=> $line[47],
						'pot_device' 							=> $line[48],
						'deduction' 							=> $line[49],
						'simpanan_pokok' 					=> $line[50],
						'simpanan_wajib_koperasi' => $line[51],
						'pembayaran_pinjaman' 		=> $line[52],
						'biaya_admin_bank' 				=> $line[53],
						'adjustment' 							=> $line[54],
						'adjustment_dlk' 					=> $line[55],
						'total' 									=> $line[56],
