...
class Pkwt437 extends MY_Controller 
{
		...
		if($pkwt[0]->approve_hrd != null){
				...
				<br>
						...
						$tbl_2 .= '
							...
							<tr>
								<td>5.</td>
								<td colspan="20">Mitra selama bekerja didaftarkan Jaminan Sosial BPJS Kesehatan dan BPJS Ketenagakerjaan oleh pihak perusahaan.</td>
							</tr>
