...
class Pkwt436 extends MY_Controller 
{
		...
		if($pkwt[0]->approve_hrd != null){
				...
				<br>
						...
						$tbl_2 .= '
							...
							<tr>
								<td>5.</td>
								<td colspan="20">5.	Bagi mitra yang tidak didaftarkan BPJS (Kesehatan/Ketenagakerjaan) oleh pihak perusahaan, Apabila terjadi kecelakaan kerja/disaat jam kerja atau Mitra dan Anggota keluarga Mitra sakit atau masuk ke Rumah Sakit maka biaya akan menjadi beban pribadi Mitra dan tidak menjadi beban perusahan.</td>
							</tr>
