...
class Pkwt400 extends MY_Controller 
{
		...
		if($pkwt[0]->approve_hrd != null){
				...
				<br>
						...
						$tbl_2 .= '
							...
							<tr>
								<td>9.</td>
								<td colspan="20">Apabila saya mitra yang bertugas telah menyelesaikan tugas dengan mencapai KPI 100% dengan mencakup seluruh toko yang terdapat dalam database toko yang sudah ditentukan, maka saya berhak menerima gaji penuh sesuai dengan ketentuan yang berlaku</td>
							</tr>

							<br>
							<tr>
								<td>10.</td>
								<td colspan="20">Apabila saya mitra yang bertugas tidak menyelesaikan tugas sesuai dengan database yang diberikan dan pencapaian KPI kurang dari 100%, maka gaji yang saya terima akan disesuaikan secara prorate sesuai dengan ketentuan area masing – masing</td>
							</tr>
							...
							<tr>
								<td></td>
								<td colspan="20"><img src="'.base_url().'assets/wardah_skema_fee_nasional.png" alt="Trulli" width="500" height="150"></td>
								<td></td>
							</tr>
