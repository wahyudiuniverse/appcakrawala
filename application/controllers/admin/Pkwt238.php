...
class Pkwt238 extends MY_Controller 
{
   	...
   	$pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
		...
		if($pkwt[0]->approve_hrd != null){
				...
				<br>
							<tr>
								<td>1.2</td>
								<td colspan="18">Tugas dan tanggung jawab yang ditetapkan tersebut diatas akan dievaluasi setiap bulannya dan per <b>3 Bulan</b>, dimana hasil yang dicapai dapat mempengaruhi dan / atau dapat dijadikan dasar untuk memperpanjang pada <b>PKWT</b> selanjutnya. Berikut merupakan jobdesk terkait :</td>
							</tr>
				<br>
							...
							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Bekerjasama dengan personel security gedung dalam menjaga keamanan dan ketertiban area kost.</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Menjaga kebersihan area kost (menyapu dan mengepel seluruh lantai 1,2,3) sehari 2 kali yaitu pagi dan sore.</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Standby ditempat yang telah ditentukan, agar bisa menangani keluhan penghuni kost dan agar bisa memberi informasi kepada pencari kost yang baru datang.</td>
							</tr>
							...
							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Mengumpulkan dan membuang sampah dari seluruh kamar kost.</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Memelihara kerapihan area luar kamar (Sepatu, plastik sampah agar diletakan yang rapih).</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Segera mengganti kran dan lampur rusak.</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Membersihkan seluruh area tangga agar tidak berdebu.</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Mengawasi agar tamu lawan jenis yang bukan muhrim penghuni kost tidak berkunjung ke dalam kamar.</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Segera melaporkan ke grup atau langsung ke petugas maintenance jika ada kerusakan di luar yang disebutkan di atas.</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Wajib melakukan tanda tangan kontrak pada waktu tertentu jika kontrak pada waktu tertentu jika kontrak telah habis (apabila di perpanjang).</td>
							</tr>
