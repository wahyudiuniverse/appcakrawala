...
class Pkwt318 extends MY_Controller 
{
	...
	public function view() {
   	...
   	$pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
		...
		if($pkwt[0]->approve_hrd != null){
					...
					$logo_cover = 'tcpdf_logo_onecorp.png';
					$header_namae = 'PT. ';
				...
				$header_namae = 'PT. Koperasi Jasa Karyawan Maju Bersama Onecorp ';
				$header_string = 'Graha Krista Aulia . Jl. Andara Raya No.20, Pangkalan Jati Baru, Kec. Cinere, Kota Depok, Jawa Barat 12450';
				...
				$pdf->SetAuthor('HRCakrawala');
				$pdf->SetTitle('PT. Koperasi Jasa Karyawan Maju Bersama Onecorp '.' - '.$this->lang->line('xin_download_profile_title'));
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify; text-justify: inter-word;">
							<tr>
								<td>Dalam hal ini bertindak untuk dan atas nama serta sah mewakili perseroan terbatas <b>PT. Koperasi Jasa Karyawan Maju Bersama Onecorp</b>, suatu Perseroan Terbatas yang bergerak dibidang Penyediaan Jasa Tenaga Kerja dan Konsultan didirikan menurut hukum Indonesa, selanjutnya disebut sebagai <b>PIHAK PERTAMA ----------------------------------------------</b></td>
							</tr>			
				</table>
				<br>
				<br>
...
<br><br>
				...
				<br>
							<tr>
								<td>m.</td>
								<td colspan="18">Bagi karyawan yang dinyatakan hamil maka karyawan harus mengundurkan diri selambat-lambatnya 3 bulan masa kehamilan dan selama proses kehamilan terjadi akibat dan resiko menjadi tanggung jawab karyawan dan bukan menjadi tanggung jawab PT. Koperasi Jasa Karyawan Maju Bersama Onecorp.</td>
							</tr>
...
<br>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify; text-justify: inter-word;">
							<tr>
								<td>Sejak bergabung karyawan wajib mengikuti koperasi PT. Koperasi Jasa Karyawan Maju Bersama Onecorp yang akan dipotongkan melalui gaji setiap bulannya, dengan perhitungan sebagai berikut :</td>
							</tr>
				</table>
				<br>
...
<br>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify; text-justify: inter-word;">
					<tr>
						<td>Selanjutnya dengan ini saya menyatakan, bahwa saya menerima, dan menyetujui serta melaksanakan ketentuan-ketentuan/tata tertib kerja PT. KOPERASI JASA KARYAWAN MAJU BERSAMA ONECORP (selanjutnya disebut “Perusahaan”) yang mengacu kepada Peraturan Perusahaan PT. KOPERASI JASA KARYAWAN MAJU BERSAMA ONECORP.</td>
					</tr>			
				</table>
				<br>
				<br>
