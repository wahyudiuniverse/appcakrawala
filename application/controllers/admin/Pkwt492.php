...
class Pkwt492 extends MY_Controller 
{
		...
		if($pkwt[0]->approve_hrd != null){
				...
				<br>
						...
						$tbl_2 .= '
							...
							<tr>
								<td>9.</td>
								<td colspan="20">Apabila saya mitra yang bertugas ingin mengakhiri kerja sama, maka wajib menyampaikan sekurang – kurangnya 7 (tujuh) hari kalender sebelum tanggal efektif pengunduran diri.</td>
							</tr>
							...
							<tr>
								<td>10.</td>
								<td colspan="20">Mitra bersedia untuk mengikuti proses evaluasi kinerja secara berkala setiap 2 (dua) minggu sekali.</td>
							</tr>
