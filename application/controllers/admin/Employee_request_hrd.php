...
class Employee_request_hrd extends MY_Controller
{
	...
	public function update_data_upah()
	{
		...
		$datarequest = [
            ...
            'gaji_pokok'			=> str_replace(".", "",$postData['gaji_pokok']),
            'allow_jabatan'			=> str_replace(".", "",$postData['allow_jabatan']),
            'dm_allow_jabatan'		=> $postData['dm_allow_jabatan'],
            'allow_skill'			=> str_replace(".", "",$postData['allow_skill']),
            'dm_allow_skill'		=> $postData['dm_allow_skill'],
            'allow_area'			=> str_replace(".", "",$postData['allow_area']),
            'dm_allow_area'			=> $postData['dm_allow_area'],
            'allow_masakerja'		=> str_replace(".", "",$postData['allow_masakerja']),
            'dm_allow_masakerja'	=> $postData['dm_allow_masakerja'],
            'allow_konsumsi'		=> str_replace(".", "",$postData['allow_konsumsi']),
            'dm_allow_konsumsi'		=> $postData['dm_allow_konsumsi'],
            'allow_transport'		=> str_replace(".", "",$postData['allow_transport']),
            'dm_allow_transport'	=> $postData['dm_allow_transport'],
            'allow_rent'			=> str_replace(".", "",$postData['allow_rent']),
            'dm_allow_rent'			=> $postData['dm_allow_rent'],
            'allow_comunication'	=> str_replace(".", "",$postData['allow_comunication']),
            'dm_allow_comunication'	=> $postData['dm_allow_comunication'],
            'allow_parking'			=> str_replace(".", "",$postData['allow_parking']),
            'dm_allow_park'			=> $postData['dm_allow_park'],
            'allow_residence_cost'	=> str_replace(".", "",$postData['allow_residence_cost']),
            'dm_allow_residance'	=> $postData['dm_allow_residance'],
            'allow_akomodsasi'		=> str_replace(".", "",$postData['allow_akomodsasi']),
            'dm_allow_akomodasi'	=> $postData['dm_allow_akomodasi'],
            'allow_device'			=> str_replace(".", "",$postData['allow_device']),
            'dm_allow_device'		=> $postData['dm_allow_device'],
            'allow_kasir'			=> str_replace(".", "",$postData['allow_kasir']),
            'dm_allow_kasir'		=> $postData['dm_allow_kasir'],
            'allow_trans_meal'		=> str_replace(".", "",$postData['allow_trans_meal']),
            'dm_allow_transmeal'	=> $postData['dm_allow_transmeal'],
            'allow_trans_rent'		=> str_replace(".", "",$postData['allow_trans_rent']),
            'dm_allow_transrent'	=> $postData['dm_allow_transrent'],
            'allow_medicine'		=> str_replace(".", "",$postData['allow_medicine']),
            'dm_allow_medicine'		=> $postData['dm_allow_medicine'],
            'allow_grooming'		=> str_replace(".", "",$postData['allow_grooming']),
            'dm_allow_grooming'		=> $postData['dm_allow_grooming'],
            'allow_kehadiran'		=> str_replace(".", "",$postData['allow_kehadiran']),
            'dm_allow_kehadiran'	=> $postData['dm_allow_kehadiran'],
            'allow_operational'		=> str_replace(".", "",$postData['allow_operational']),
            'dm_allow_operational'	=> $postData['dm_allow_operational'],
            'allow_training'		=> str_replace(".", "",$postData['allow_training']),
            'dm_allow_training'		=> $postData['dm_allow_training'],
            'allow_kinerja'			=> str_replace(".", "",$postData['allow_kinerja']),
            'dm_allow_kinerja'		=> $postData['dm_allow_kinerja'],
            'allow_disiplin'		=> str_replace(".", "",$postData['allow_disiplin']),
            'dm_allow_disiplin'		=> $postData['dm_allow_disiplin'],
            'allow_pph'				=> str_replace(".", "",$postData['allow_pph']),
            'dm_allow_pph'			=> $postData['dm_allow_pph'],
            'allow_others'			=> str_replace(".", "",$postData['allow_others']),
