...
class Pkwt402 extends MY_Controller 
{
	...
	public function view() {
   	...
   	$pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
		...
		if ($pkwt[0]->jabatan=='155') {
			redirect('admin/pkwt402pic/view/'.$pkwt[0]->uniqueid);
...
<br>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td >13.</td>
								<td colspan="20">Karyawan wajib membayar deposit sebesar Rp 1.500.000,- (satu juta lima ratus ribu rupiah). Pembayaran deposit tersebut akan dilakukan melalui pemotongan gaji karyawan setiap bulan sebesar Rp 500.000,- (lima ratus ribu rupiah) hingga jumlah deposit terpenuhi. Adanya pemotongan deposit ini guna mengurangi resiko fraud dan akan dikembalikan jika karyawan mengundurkan diri.</td>
								<td colspan="0"></td>
							</tr>
