...
class Pkwt203 extends MY_Controller 
{
...
<br>
				...
				<tr>
					<td>Ketentuan Allowance</td>
					<td colspan="5"> <img src="'.base_url().'assets/ketentuan_allowance_danone.png" alt="Trulli" width="600" height="120"> </td>
				</tr>
