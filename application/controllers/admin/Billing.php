...
class Billing extends MY_Controller {
	...
	public function index() {
		...
		if(empty($session)){ 
			...
			$data['title'] = 'Report | Billing';
			$data['breadcrumbs'] = 'Report Billing';
			$data['path_url'] = 'emp_view';
			// $data['all_projects'] = $this->Project_model->get_project_maping($session['employee_id']);
			$data['region_billing'] = $this->Billing_model->get_region_billing($session['employee_id']);
	...
	public function list_billing()
	{
		...
		// Get data
		$data = $this->Billing_model->get_list_billing($postData);
