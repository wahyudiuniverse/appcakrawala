...
class Pkwt254toa extends MY_Controller 
{
   	...
   	$pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
		...
		if($pkwt[0]->approve_hrd != null){
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							<tr>
								<td>1.1</td>
								<td colspan="18"><b>PIHAK PERTAMA</b> akan menempatkan <b>PIHAK KEDUA</b> dilokasi kerja <b>PIHAK PERTAMA</b> yaitu di '.$penempatan.' dengan posisi sebagai karyawan/Staff PC TT di Jakarta atau ditempatkan di tempat lain sesuai dengan kebutuhan <b>PIHAK PERTAMA</b>.</td>
							</tr>
				<br>
							<tr>
								<td>1.2</td>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							<tr>
								<td>2.1</td>
								<td colspan="18">PKWT ini berlangsung/berlaku selama <b>3</b> Bulan terhitung sejak <b>
													15 Januari 2024</b> sampai dengan <b>15 Maret 2024</b> Selama <b>PIHAK KEDUA</b> menjadi Karyawan Kontrak maka akan ada masa Evaluasi kinerja setiap bulan dan atau per <b>3 Bulan</b>.</td>
							</tr>
				<br>
							<tr>
								<td>2.2</td>
				...
				<br><br><br>
							<tr>
								<td>4.2</td>
								<td colspan="18">Ketentuan waktu kerja ditentukan oleh <b>PIHAK PERTAMA</b> sesuai dengan peraturan undang – undang ketenagakerjaan dan dapat berubah sewaktu – waktu sesuai dengan kebutuhan <b>PIHAK PERTAMA</b>. Setiap perubahan waktu kerja akan diinformasikan kepada <b>PIHAK KEDUA</b> dan bersifat mengikat.
</td>
							</tr>
				<br>
							<tr>
...
<br><br>
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td ></td>
								<td colspan="20">6 Hari Kerja dalam 7 (Tujuh) hari kalender	:</td>
								<td colspan="0"></td>
							</tr>
							...
							<tr>
								<td colspan="2"></td>
								<td >•</td>
								<td colspan="18">Hari Senin - Sabtu 09:00 - 18:00</td>
								<td colspan="0"></td>
							</tr>
							...
							<tr>
								<td colspan="2"></td>
								<td >•</td>
								<td colspan="18">Hari libur Minggu</td>
								<td colspan="0"></td>
							</tr>

							<tr>
								<td ></td>
								<td colspan="20">Atau disesuaikan dengan ketentuan klien/perusahaan</td>
								<td colspan="0"></td>
							</tr>
