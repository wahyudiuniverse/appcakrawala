...
class Pkwt205helper extends MY_Controller 
{
...
<br>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td >13.</td>
								<td colspan="20">Absensi wajib 100% apabila selama bekerja terdapat sakit dan izin, Maka saya bersedia untuk dipotongkan gaji pada hari tersebut sebesar Rp. 150.000</td>
								<td colspan="0"></td>
							</tr>

							<tr>
								<td >14.</td>
								<td colspan="20">Apabila saya selaku helper yang bertugas untuk melakukan pengiriman barang ke toko, maka barang tersebut wajib terkirim ke toko apabila barang tidak terkirim sesuai dengan kondisi dan waktu yang sudah ditentukan maka akan mempengaruhi <i>review performance</i>/KPI</td>
								<td colspan="0"></td>
							</tr>

							<tr>
								<td >15.</td>
								<td colspan="20">Waktu ishoma (Istirahat, Sholat, Makan) terhitung pada pukul 12:00-13:00</td>
								<td colspan="0"></td>
							</tr>

							<tr>
								<td >16.</td>
								<td colspan="20">Saya selaku helper bertanggung jawab atas kegiatan loading barang, baik barang yang masuk dan barang yang keluar</td>
								<td colspan="0"></td>
							</tr>
