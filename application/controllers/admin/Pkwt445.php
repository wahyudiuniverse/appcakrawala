...
class Pkwt445 extends MY_Controller 
{
   	...
   	$pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
		...
		if($pkwt[0]->approve_hrd != null){
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td ></td>
								<td colspan="20">Jaminan ketenagakerjaan (BPJS Tenaga kerja), penetapan syarat berserta ketentuan yang berlaku  sepenuhnya menjadi hak <b>PIHAK PERTAMA</b>.</td>
								<td colspan="0"></td>
							</tr>
							...
							<tr>
								<td ></td>
								<td colspan="20">Note : -Bpjs Ketenagakerjaan akan didaftarkan setelah karyawan bekerja.</td>
								<td colspan="0"></td>
							</tr>
							...
							<tr>
								<td ></td>
								<td colspan="0">-</td>
								<td colspan="20">Iuran <b>BPJS Ketenagakerjaan (JKK & JKM)</b>.</td>
							</tr>
				</table>
				<br>
				<br>
...
<br>
				...
				$lampiran .= '	
					<br>
						<tr>
							<td colspan="20">Note: Rincian gaji diatas belum termasuk potongan BPJS Ketenagakerjaan maupun PPH21.</td>
							<td></td>
						</tr>
				...
				<tr>
					...
					<td colspan="5">Periode perhitungan upah adalah tanggal '.$tgl_mulaiperiode_payment.' ke '.$tgl_akhirperiode_payment.' bulan berjalan <br>(Disesuaikan dengan bulan berjalan pada akhir bulan) <br>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="5">Jaminan Kecelakaan Kerja 0,24% ditanggung oleh Pihak Pertama<br>Jaminan Kematian 0,30 % ditanggung oleh Pihak Pertama<br></td>
				</tr>
