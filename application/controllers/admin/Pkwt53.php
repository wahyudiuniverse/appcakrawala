...
class Pkwt53 extends MY_Controller 
{
   	...
   	$pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
		...
		if($pkwt[0]->approve_hrd != null){
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							<tr>
								<td>a.</td>
								<td colspan="18"><b>PKWT</b> ini berlangsung/berlaku selama <b>'.$waktukontrak.'</b> terhitung sejak <b>'.$this->Xin_model->tgl_indo($tglmulaipkwt).'</b> sampai dengan <b>'.$this->Xin_model->tgl_indo($tglakhirpkwt).'</b>. Selama <b>PIHAK KEDUA</b> menjadi Karyawan Kontrak maka akan ada masa <i>Evaluasi kinerja</i> setiap bulan dan atau per <b>3 Bulan</b>.
								</td>
							</tr>
				<br>
							<tr>
								<td>b.</td>
								<td colspan="18">Jika <b>PIHAK KEDUA</b> setelah masa <i>Evaluasi Kinerja</i> 3 Bulan dan atau 6 Bulan dan oleh <b>PIHAK PERTAMA</b> atau Pihak User/Klien diperpanjang maka PIHAK KEDUA tetap melanjutkan PKWT yang sudah berlangsung/berlaku sampai PKWT berakhir.</td>
							</tr>
				<br>
							<tr>
								<td>c.</td>
								<td colspan="18"><b>PIHAK PERTAMA</b> berhak memutuskan/memberhentikan PKWT <b>PIHAK KEDUA</b> apabila jika pada saat masa <i>Evaluasi Kinerja</i> tidak sesuai dengan komitmen dan kinerja, walaupun PKWT masih berlaku/berjalan.</td>
							</tr>
				</table>
				<br>
