...
class Pkwt412 extends MY_Controller 
{
				...
				<br>
						...
						$tbl_2 .= '
							...
							<tr>
								<td colspan="0"></td>
								<td colspan="1">•</td>
								<td colspan="20">Total Tunjangan Transport Harian yang didapatkan sebesar '.$allowance_transport.'.</td>
							</tr>
							...
							<tr>
								<td>5.</td>
								<td colspan="20">Sebagai mitra yang bertugas, saya akan didaftarkan dalam program BPJS (Kesehatan dan Ketenagakerjaan), dengan seluruh biaya iuran ditanggung oleh klien, '.$client.'.</td>
							</tr>
