...
class Pkwt216md extends MY_Controller 
{
	...
	public function view() {
   	...
   	$pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
		...
		if($pkwt[0]->approve_hrd != null){
				...
				$header_namae = 'PT. Siprama Cakrawala MD';
...
<br>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td >13.</td>
								<td colspan="20">Target call harian sebanyak 15 toko, jika diakumulasikan dalam 6 hari kerja sebanyak 90 toko. Apabila dalam 1 hari karyawan tidak mencapai 15 toko maka dapat di adjustment dihari berikutnya. Apabila dalam 1 bulan karyawan tidak mencapai target yang ditentukan maka akan dilakukan review performance</td>
								<td colspan="0"></td>
							</tr>
							...
							<tr>
								<td ></td>
								<td colspan="20">
<img src="'.base_url().'assets/oatside_pkwt_dimensi_kpi_md.png" alt="Trulli" width="400" height="240"></td>
								<td colspan="0"></td>
							</tr>
