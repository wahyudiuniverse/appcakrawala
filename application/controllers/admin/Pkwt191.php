...
<br>
					...
					<img src="'.base_url().'assets/lampiran2_mrc.png" alt="Trulli" width="650" height="450">
...
<br><br>
				...
				<tr>
					<td colspan="15">Tidak mencapai target yang telah ditentukan sebanyak 1 kali.</td>
					<td colspan="5" style="text-align:center">Ringan</td>
					<td colspan="5" style="text-align:center">I</td>
					<td colspan="5" style="text-align:center">SP1</td>
					<td colspan="8" style="text-align:center">Pembinaan disertai Surat Peringatan (SP 1)</td>
				...
				<tr>
					<td colspan="15">Tidak mencapai target yang telah ditentukan sebanyak 2 kali, akumulasi atau berturut-turut.</td>
					<td colspan="5" style="text-align:center">Sedang</td>
					<td colspan="5" style="text-align:center">II</td>
					<td colspan="5" style="text-align:center">SP2</td>
					<td colspan="8" style="text-align:center">Pembinaan disertai Surat Peringatan (SP 2)</td>
				...
				<tr>
					<td colspan="15">Tidak mencapai taíget yang telah ditentukan sebanyak 3 kali, akumulasi atau berturut-turut</td>
				...
				<tr>
					<td colspan="15">Tidak mencapai target yang telah ditentukan sebanyak 4 kali, akumulasi atau berturut-turut.</td>
					<td colspan="5" style="text-align:center">Termination</td>
