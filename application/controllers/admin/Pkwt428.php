...
class Pkwt428 extends MY_Controller 
{
		...
		if($pkwt[0]->approve_hrd != null){
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td ></td>
								<td colspan="0"></td>
								<td colspan="20"><br>•	Hari Senin - Sabtu 	8 Jam Kerja<br>•	Hari libur Minggu</td>
							</tr>	

							<tr>	
								<td ></td>
								<td colspan="20">Total jam Kerja dalam 7 (Tujuh) hari kalender (1 minggu) adalah 48 Jam Kerja atau sesuai dengan ketentuan klien/perusahaan.</td>
								<td colspan="0"></td>
							</tr>
...
<br>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td >13.</td>
								<td colspan="20">Wajib menggunakan Aplikasi Trec untuk absensi kehadiran. Apabila absensi tidak terdeteksi pada aplikasi Trec, maka gaji pada hari tersebut tidak dibayarkan atau tidak dihitung.</td>
								<td colspan="0"></td>
							</tr>

							<tr>
								<td >14.</td>
								<td colspan="20">Jika karyawan izin selama 3 hari berturut – turut dalam 3 bulan, maka kontrak akan diselesaikan.</td>
								<td colspan="0"></td>
							</tr>
