...
class Pkwt377 extends MY_Controller 
{
		...
		if($pkwt[0]->approve_hrd != null){
				...
				<br>
							...
							<tr>
								<td colspan="0"></td>
								<td colspan="1">•</td>
								<td colspan="20">'.$basicpay.' Upah diberikan sesuai dengan kehadiran '.$waktukerja.' Hari Kerja dalam 1 bulan kerja, sehingga Total Upah Harian yang didapat sebesar <b>'.$this->Xin_model->rupiah($sum_salary/$waktukerja).'/ Hari</b></td>
							</tr>';
