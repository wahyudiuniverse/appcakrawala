...
class Pkwt589 extends MY_Controller 
{
   	...
   	$pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
		...
		if($pkwt[0]->approve_hrd != null){
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							<tr>
								<td>4.1</td>
								<td colspan="18">Hari kerja menyesuaikan jumlah hari kerja pada bulan berjalan</td>
							</tr>
				<br>
							<tr>
								<td>4.2</td>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td ></td>
								<td colspan="0"></td>
								<td colspan="20"><br>•	Hari Selasa - Minggu<br>•	Hari libur Senin</td>
							</tr>
...
<br>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td >13.</td>
								<td colspan="20">Apabila saya karyawan yang bertugas tidak masuk bekerja dengan alasan sakit namun tidak melampirkan Surat Keterangan Dokter (SKD) yang sah dalam satu periode penggajian, maka karyawan bersedia dilakukan pemotongan gaji secara prorata (prorate) sesuai jumlah ketidakhadiran.</td>
								<td colspan="0"></td>
							</tr>

							<tr>
								<td >14.</td>
								<td colspan="20">Apabila saya karyawan yang bertugas tidak masuk bekerja dengan alasan sakit dan melampirkan Surat Keterangan Dokter (SKD) yang sah, maka tidak dilakukan pemotongan gaji pokok. Namun, pemotongan diberlakukan hanya pada komponen allowance sesuai dengan ketentuan yang berlaku.</td>
								<td colspan="0"></td>
							</tr>
				...
				<tr>
					<td>Waktu Kerja</td>
					<td colspan="5">Jam kerja menyesuaikan dengan ketentuan dari klien</td>
				</tr>
				<tr>
