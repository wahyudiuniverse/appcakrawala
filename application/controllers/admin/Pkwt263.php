...
class Pkwt263 extends MY_Controller 
{
							...
							<tr>
								...
								<td colspan="18">PKWT ini berlangsung/berlaku selama <b>'.$waktukontrak.'</b> Bulan terhitung sejak <b>
													'.$this->Xin_model->tgl_indo($tglmulaipkwt).'</b> sampai dengan <b>
																		'.$this->Xin_model->tgl_indo($tglakhirpkwt).'</b> Selama <b>PIHAK KEDUA</b> menjadi Karyawan Kontrak maka akan ada masa <i>Evaluasi kinerja</i> per Bulan atau per 3 Bulan</td>
							</tr>
				<br>
							<tr>
								<td>b.</td>
								<td colspan="18">Jika <b>PIHAK KEDUA</b> setelah masa <i>Evaluasi Kinerja</i> per Bulan dan atau per 3 Bulan dan oleh <b>PIHAK PERTAMA</b> atau Pihak User/Klien diperpanjang maka <b>PIHAK KEDUA</b> tetap melanjutkan PKWT yang sudah berlangsung/berlaku sampai PKWT berakhir.</td>
							</tr>
				<br>
							<tr>
								<td>c.</td>
...
<br><br><br><br><br>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td ></td>
								<td colspan="0">b.</td>
								<td colspan="20">Selama saya menjadi Karyawan Kontrak maka akan ada Evaluasi kinerja 1 Bulan dan atau per 3 Bulan</td>
							</tr>
							<tr>
								<td ></td>
								<td colspan="0">c.</td>
							...
							<tr>
								<td ></td>
								<td colspan="0">a.</td>
								<td colspan="20">Saya selaku Area Koordinator Motoris bertanggung jawab dan memonitoring team dibawah saya yaitu Koordinator Motoris & Motoris untuk melakukan pekerjaan sesuai dengan SOP salah satunya ialah melakukan setoran hasil penjualan kepada pihak distributor yang ditunjuk apabila melakukan pelanggaran atas sop tersebut detail (penyelesaiannya terdapat dalam surat pernyataan komitmen) dan bersedia untuk tidak diberikan gaji sampai permasalahan selesai pelanggaran ini di anggap selesai oleh kedua belah pihak.</td>
							</tr>
			...
			// surat perjanjian
				...
				<div style="text-align: center; text-justify: inter-word;">
					<b><u>SURAT PERNYATAAN KOMITMEN</u></b>
				</div>
				<br>
				<br>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify; text-justify: inter-word;">
					<tr>
						<td>Saya yang bertanda tangan dan membuat dibawah ini :</td>
					</tr>			
				</table>
				<br>
				<br>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify; text-justify: inter-word;">
					<tr>
						<td>Demikian surat yang saya buat untuk dipergunakan sebagaimana mestinya, terimakasih.</td>
					</tr>			
				</table>
				<br><br>
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify; text-justify: inter-word;">
					<tr>
						<td>'.$this->Xin_model->tgl_indo($tanggalcetak).'</td>
				...
				$pdf->writeHTML($tbl_spk, true, false, false, false, '');
				...
				<table cellpadding="2" cellspacing="0" border="0">
					...
					<tr>
						...
						<td><br><br><b><br><u></u></b> &nbsp;&nbsp;&nbsp;&nbsp;</td>
					</tr>

					<tr>
						<td>(&nbsp;&nbsp;'.$namalengkap.'&nbsp;&nbsp;)<br>'.$jabatan.'</td>
						<td></td>
					</tr>

				</table>';

				$pdf->writeHTML($tbl_ttd_spk, true, false, false, false, '');
