...
class Pkwt453 extends MY_Controller 
{
...
<br>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td >15.</td>
								<td colspan="20">Apabila tanggal 27 jatuh pada akhir pekan atau hari libur, maka proses penggajian akan diproses pada hari kerja berikutnya.</td>
								<td colspan="0"></td>
							</tr>

							<tr>
								<td >16.</td>
								<td colspan="20">Bahwa saya akan mencapai target visit 11 toko per hari ( 5 MT,6MM).</td>
								<td colspan="0"></td>
							</tr>
