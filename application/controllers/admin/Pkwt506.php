...
class Pkwt506 extends MY_Controller 
{
				...
				<br>
						...
						$tbl_2 .= '
							...
							<tr>
								<td colspan="0"></td>
								<td colspan="1">•</td>
								<td colspan="20">Total Upah yang didapatkan '.$basicpay.'.</td>
							</tr>';
						...
						$tbl_2 .= '
							...
							<tr>
								<td colspan="0"></td>
								<td colspan="1">•</td>
								<td colspan="20">Uang Makan diberikan '.$allowance_meal.' .</td>
							</tr>';
						}
						...
						$tbl_2 .= '
							...
							<tr>
								<td colspan="0"></td>
								<td colspan="1">•</td>
								<td colspan="20">Uang Transport diberikan '.$allowance_transport.' .</td>
							</tr>';
					...
					$tbl_2 .= '
							...
							<tr>
								<td>6.</td>
								<td colspan="20">Mitra wajib mengikuti koperasi PT. Siprama Cakrawala yang akan dipotongkan melalui gaji setiap bulannya sebesar Rp 50.000,-</td>
							</tr>
							...
							<tr>
								<td>10.</td>
								<td colspan="20">Apabila saya mitra yang bertugas tidak hadir bekerja tanpa pemberitahuan, maka dinyatakan alfa dan perusahaan akan melakukan pemotongan upah sesuai dengan jumlah hari ketidakhadiran, serta dapat memberikan sanksi disiplin sesuai dengan ketentuan dan peraturan perusahaan yang berlaku</td>
							</tr>
							...
							<tr>
								<td>11.</td>
								<td colspan="20">Apabila saya mitra yang bertugas mengajukan izin namun tidak termasuk dalam kategori izin berbayar, maka perusahaan berhak melakukan pemotongan upah sesuai dengan jumlah hari izin yang diambil</td>
							</tr>
							...
							<tr>
								<td>12.</td>
								<td colspan="20">Apabila saya mitra yang bertugas datang melewati jam kerja yang telah ditentukan akan dicatat sebagai keterlambatan, maka perusahaan berhak melakukan pemotongan upah berdasarkan akumulasi menit atau jam keterlambatan, atau dikonversikan menjadi potongan upah harian sesuai dengan ketentuan dan kebijakan perusahaan yang berlaku</td>
							</tr>
							...
							<tr>
								<td>13.</td>
								<td colspan="20">Apabila saya mitra yang bertugas meninggalkan tempat kerja sebelum berakhirnya jam kerja tanpa persetujuan, maka dianggap melakukan pelanggaran kedisiplinan dan perusahaan berhak melakukan pemotongan upah berdasarkan waktu kerja yang tidak dijalankan.</td>
							</tr>
							...
							<tr>
								<td>14.</td>
								<td colspan="20">Apabila saya mitra bertugas tidak masuk bekerja selama beberapa hari berturut-turut tanpa pemberitahuan atau keterangan yang sah akan dianggap mangkir, maka perusahaan berhak melakukan pemotongan upah sesuai dengan jumlah hari ketidakhadiran.</td>
							</tr>
							...
							<tr>
								<td>15.</td>
								<td colspan="20">Apabila saya mitra bertugas hadir bekerja namun tidak melakukan absensi sesuai dengan sistem dan ketentuan yang berlaku wajib melakukan konfirmasi dengan pihak HR. Dan apabila tidak terdapat konfirmasi, maka kehadiran tersebut dapat dianggap tidak tercatat sebagai kehadiran dan perusahaan berhak melakukan pemotongan upah.</td>
							</tr>
