...
class Pkwt262 extends MY_Controller 
{
   	...
   	$pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
		...
		if($pkwt[0]->approve_hrd != null){
				...
				<br>
							<tr>
								<td>b.</td>
								<td colspan="18">Jika <b>PIHAK KEDUA</b> setelah <i>Evaluasi Kinerja</i> setiap bulannya dan atau 3 Bulan dan oleh <b>PIHAK PERTAMA</b> atau Pihak User/Klien diperpanjang maka <b>PIHAK KEDUA</b> tetap melanjutkan PKWT yang sudah berlangsung/berlaku sampai PKWT berakhir.</td>
							</tr>
				<br>
							<tr>
								<td>c.</td>
...
<br><br><br><br><br>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td ></td>
								<td colspan="0">a.</td>
								<td colspan="20">Project Manager bertanggung jawab dan memonitoring team dibawah saya yaitu Area Kooridnator Motoris (AKM), Koordinator Motoris (KORMOT) dan, Motoris untuk melakukan pekerjaan sesuai dengan SOP salah satunya ialah melakukan setoran hasil penjualan kepada pihak distributor yang ditunjuk dan apabila melakukan pelanggaran atas sop tersebut detail penyelesaiannya terdapat dalam surat pernyataan komitmen.</td>
							</tr>
