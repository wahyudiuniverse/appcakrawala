...
class Pkwt125gfta extends MY_Controller 
{
   	...
   	$pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
		...
		if($pkwt[0]->approve_hrd != null){
				...
				<br>
							<tr>
								<td>1.2</td>
								<td colspan="18">Tugas dan tanggung jawab yang ditetapkan tersebut diatas akan dievaluasi setiap <b>6 Bulan</b>, dimana hasil yang dicapai dapat mempengaruhi dan / atau dapat dijadikan dasar untuk memperpanjang pada <b>PKWT</b> selanjutnya.</td>
							</tr>
				<br>
							<tr>
								<td>1.3</td>
							...
							<tr>
								...
								<td colspan="18">PKWT ini berlangsung/berlaku selama <b>'.$waktukontrak.'</b> Bulan terhitung sejak <b>
													'.$this->Xin_model->tgl_indo($tglmulaipkwt).'</b> sampai dengan <b>
																		'.$this->Xin_model->tgl_indo($tglakhirpkwt).'</b> Selama <b>PIHAK KEDUA</b> menjadi Karyawan Kontrak maka akan ada masa Evaluasi kinerja setiap bulan dan atau per <b>6 Bulan</b>.</td>
							</tr>
				<br>
							<tr>
								<td>2.2</td>
								<td colspan="18">Jika <b>PIHAK KEDUA</b> setelah masa Evaluasi Kinerja 6 Bulan dan oleh <b>PIHAK PERTAMA</b> atau Pihak User/Klien diperpanjang maka <b>PIHAK KEDUA</b> tetap melanjutkan PKWT yang sudah berlangsung/berlaku sampai PKWT berakhir.</td>
							</tr>
				<br>
							<tr>
								<td>2.3</td>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td >3.4</td>
								<td colspan="20"><b>PIHAK KEDUA</b> berhak mendapatkan cuti tahunan selama 12 hari dalam 1 (satu) tahun, jika masa kerja sudah melampui 1 Tahun (12 Bulan) yang diatur dan kebijakan oleh <b>PIHAK PERTAMA</b> berdasarkan kebutuhan dan kesepakatan dengan pihak User/Klien (berlaku bagi karyawan kontrak).</td>
								<td colspan="0"></td>
							</tr>
							<br>
							<tr>
...
<br>
				...
				<br>
							<tr>
								<td>4.2</td>
								<td colspan="18">Ketentuan waktu kerja ditentukan oleh PIHAK PERTAMA sesuai dengan peraturan undang – undang ketenagakerjaan dan dapat berubah sewaktu – waktu sesuai dengan kebutuhan PIHAK PERTAMA. Setiap perubahan waktu kerja akan diinformasikan kepada PIHAK KEDUA dan bersifat  mengikat.</td>
							</tr>
				<br>
							<tr>
								<td>4.3</td>
								<td colspan="18">PIHAK KEDUA berkewajiban untuk mematuhi waktu kerja dan kehadiran/jadwal kerja sebagai mana dimaksud dalam pasal ini dan wajib mematuhi jadwal/jam kerja yang dikeluarkan oleh PIHAK PERTAMA. Dan atau akan diberikan sanksi jika tidak mematuhi jadwal/jam kerja tersebut.</td>
							</tr>
...
<br>
				...
				<br>
							...
							<tr>
								<td ></td>
								<td colspan="0">c)</td>
								<td colspan="20">Wajib melampirkan exit cleareance  yang telah ditanda tangani oleh PIHAK PERTAMA dan Klien PIHAK PERTAMA.</td>
							</tr>
							<br>
<br>
							<tr>
...
<br>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td ></td>
								<td colspan="0">b.</td>
								<td colspan="20">Selama saya menjadi Karyawan Kontrak maka akan ada Evaluasi kinerja setiap bulan dan atau <b>per 6 Bulan</b>. </td>
							</tr>
							<tr>
								<td ></td>
								<td colspan="0">c.</td>
