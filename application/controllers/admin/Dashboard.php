...
class Dashboard extends MY_Controller {
	...
	// get hrpremium roles > chart
	public function hrpremium_roles()
	{
		/* Define return | here result is used to return user data and error for error message */
		$Return = array('chart_data'=>'', 'c_name'=>'', 'd_rows'=>'','c_color'=>'');
		$c_name = array();
		...
		$someArray = array();
		$j=0;
		foreach(hrpremium_roles() as $hr_roles) { 
	...
	// get hrpremium roles > chart
	public function hrpremium_office_shifts()
	{
		/* Define return | here result is used to return user data and error for error message */
		$Return = array('chart_data'=>'', 'c_name'=>'', 'd_rows'=>'','c_color'=>'');
		$c_name = array();
		...
		$someArray = array();
		$j=0;
		foreach(hrpremium_office_shift() as $hr_office_shift) { 
	...
	// get payroll | salary
	public function hrpremium_payroll()
	{
		/* Define return | here result is used to return user data and error for error message */
		...
		for ($i = 0; $i <= 5; $i++) 
		{
		   ...
		   $amount = hrpremium_payroll($months);
	...
	// get payroll | salary
	public function hrpremium_user_payroll()
	{
		/* Define return | here result is used to return user data and error for error message */
		$Return = array('chart_data'=>'', 'c_name'=>'', 'c_am'=>'');
		$c_name = array();
		...
		{
		   $months = date("Y-m", strtotime( date( 'Y-m-01' )." -$i months"));
		   $amount = ihrpremium_user_payroll($months,$session['user_id']);
		   $payroll_amount = $amount;
		   $c_name[] = $months;
			$someArray[] = array(
				'label'   => $months,
	...
	// get expense deposit
	public function hrpremium_expense_deposit()
	{
		/* Define return | here result is used to return user data and error for error message */
	...
	// overtime request
	public function hrpremium_overtime_request()
	{
		/* Define return | here result is used to return user data and error for error message */
	...
	// hrpremium clients leads
	public function hrpremium_clients_leads()
	{
		/* Define return | here result is used to return user data and error for error message */
