...
class Pkwt116 extends MY_Controller 
{
		...
		if($pkwt[0]->approve_hrd != null){
				...
				<br>
							...
							<tr>
								<td ></td>
								<td colspan="0">c)</td>
								<td colspan="20">Wajib melampirkan exit cleareance  yang telah ditanda tangani oleh PIHAK PERTAMA dan Klien <b>PIHAK PERTAMA</b>.</td>
							</tr>
