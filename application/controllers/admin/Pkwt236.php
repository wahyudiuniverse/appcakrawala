...
class Pkwt236 extends MY_Controller 
{
   	...
   	$pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
		...
		if($pkwt[0]->approve_hrd != null){
				...
				<br>
							<tr>
								<td>1.2</td>
								<td colspan="18">Tugas dan tanggung jawab yang ditetapkan tersebut diatas akan dievaluasi setiap bulannya dan per 3 Bulan, dimana hasil yang dicapai dapat mempengaruhi dan / atau dapat dijadikan dasar untuk memperpanjang pada PKWT selanjutnya. Berikut merupakan jobdesk terkait :</td>
							</tr>
				<br>
							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Melakukan panggilan azan di setiap waktu sholat termasuk hari Sabtu, Minggu dan hari libur nasional.</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Melakukan tindakan menjaga kebersihan di area masjid dan kantin meliputi :</td>
							</tr>
							...
							<tr>
								...
								<td></td>
								<td calspan="2">-</td>
								<td colspan="18">Meja dan kursi harus dalam keadaan bersih.</td>
							</tr>
							...
							<tr>
								...
								<td></td>
								<td calspan="2">-</td>
								<td colspan="18">Tembok kantin harus bersih dari coret-coretan dan sarang laba-laba</td>
							</tr>
							...
							<tr>
								...
								<td></td>
								<td calspan="2">-</td>
								<td colspan="18">Membersihkan kipas kantin seminggu sekali</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Melakukan penggantian kran yang rusak (di kantin dan masjid)</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Melakukan penataan mukena dan sarung di masjid agar selalu rapi.</td>
							</tr>
							...
							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Melakukan pencucian sajadah, mukenah dan sarung (2 minggu sekali).</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Pembersihan karpet masjid (vakum).</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Penjemuran karpet masjid.</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Memastikan toilet masjid dalam keadaan bersih.</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Melaporkan seluruh kerusakan (selain yang telah disebutkan diatas) kepada pihak maintetnace 	 gedung atau lapor di grup.</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Mempersiapkan solat jumat.</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Mempersiapkan kebutuhan shola ied (jika diadakan dikantor).</td>
							</tr>

							<tr>
								<td></td>
								<td calspan="2">•</td>
								<td colspan="18">Wajib melakukan tanda tangan kontrak pada waktu tertentu jika kontrak telah habis (apabila di 	 perpanjang).</td>
							</tr>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td></td>
								<td colspan="18">Hari kerja Senin, Rabu – Minggu dan libur pada hari Selasa.</td>
							</tr>
				<br>
							<tr>
								<td>4.2</td>
								<td colspan="18">Jam kerja operasional 08:00 s/d 17:00.</td>
							</tr>
				<br>
							<tr>
								<td>4.3</td>
								<td colspan="18">Ketentuan waktu kerja ditentukan oleh PIHAK PERTAMA sesuai dengan peraturan undang – undang ketenagakerjaan dan dapat berubah sewaktu – waktu sesuai dengan kebutuhan PIHAK PERTAMA. Setiap perubahan waktu kerja akan diinformasikan kepada <b>PIHAK KEDUA</b> dan bersifat  mengikat.</td>
							</tr>
				<br>
							<tr>
								<td>4.4</td>
				...
				<br>
							<tr>
								<td>4.5</td>
								<td colspan="18">Wajib melakukan absen finger print, apabila tidak melakukan absen finger print maka dianggap tidak hadir/alfa.</td>
							</tr>
