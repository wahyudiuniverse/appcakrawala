...
class Employee_resign_history extends MY_Controller {
	...
	public function index() {
		...
		$data['title'] = 'Monitoring Paklaring | '.$this->Xin_model->site_title();
		...
		$data['breadcrumbs'] = 'History Paklaring';
	...
	public function request_list() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("admin/employees/resign_list_history", $data);
		} else {
			redirect('admin/');
		}
		...
		$employee = $this->Employees_model->get_monitoring_rsign_history();
