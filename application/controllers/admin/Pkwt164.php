...
class Pkwt164 extends MY_Controller 
{
	...
	public function view() {
   	...
   	$pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
		...
		if($pkwt[0]->approve_hrd != null){
				...
				$pdf->SetAuthor('HRCakrawala');
				$pdf->SetTitle('PT. Mata Cakrawala '.' - '.$this->lang->line('xin_download_profile_title'));
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify; text-justify: inter-word;">
							<tr>
								<td>Dalam hal ini bertindak untuk dan atas nama serta sah mewakili perseroan terbatas <b>PT. Mata Cakrawala</b>, suatu Perseroan Terbatas yang bergerak dibidang Penyediaan Jasa Tenaga Kerja dan Konsultan didirikan menurut hukum Indonesa, selanjutnya disebut sebagai <b>PIHAK PERTAMA ----------------------------------------------</b></td>
							</tr>			
				</table>
				<br>
				<br>
...
<br><br><br><br><br><br><br>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td ></td>
								<td colspan="20">5 Hari Kerja dalam 7 (Tujuh) hari kalender	:</td>
								<td colspan="0"></td>
							</tr>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td>a.</td>
								<td colspan="20">PIHAK PERTAMA dan Klien memutuskan hubungan kerja sepihak dengan alasan apaun tanpa mengeluarkan surat peringatan 1,2 dan 3. Dan PIHAK KEDUA tidak berhak menuntut apapun dan salary dari sisa kontrak, pesangon dan tali kasih dalam bentuk apapun.</td>
							</tr>
				...
				<br>
							<tr>
								<td>m.</td>
								<td colspan="18">Bagi karyawan yang dinyatakan hamil maka karyawan harus mengundurkan diri selambat-lambatnya 3 bulan masa kehamilan dan selama proses kehamilan terjadi akibat dan resiko menjadi tanggung jawab karyawan dan bukan menjadi tanggung jawab PT. Mata Cakrawala.</td>
							</tr>
...
<br>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify; text-justify: inter-word;">
					<tr>
						<td>Selanjutnya dengan ini saya menyatakan, bahwa saya menerima, dan menyetujui serta melaksanakan ketentuan-ketentuan/tata tertib kerja PT. MATA CAKRAWALA (selanjutnya disebut “Perusahaan”) yang mengacu kepada Peraturan Perusahaan PT. MATA CAKRAWALA.</td>
					</tr>			
				</table>
				<br>
				<br>
