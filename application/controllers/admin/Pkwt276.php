...
class Pkwt276 extends MY_Controller 
{
				...
				<br>
						...
						$tbl_2 .= '
							...
							<tr>
								<td colspan="0"></td>
								<td colspan="1">•</td>
								<td colspan="20"> '.$this->Xin_model->rupiah($basic_pay).' Upah diberikan sesuai dengan kehadiran 25 Hari Kerja dalam 1 bulan kerja.</td>
							</tr>

							<tr>
								<td colspan="0"></td>
								<td colspan="1">•</td>
								<td colspan="20"> '.$this->Xin_model->rupiah($pkwt[0]->allowance_transport).' Uang Transport diberikan sesuai dengan kehadiran 25 Hari Kerja dalam 1 bulan kerja.</td>
							</tr>

							<tr>
								<td colspan="0"></td>
								<td colspan="1">•</td>
								<td colspan="20"> '.$this->Xin_model->rupiah($pkwt[0]->allowance_meal).' Uang Makan diberikan sesuai dengan kehadiran 25 Hari Kerja dalam 1 bulan kerja.</td>
							</tr>

							<tr>
								<td colspan="0"></td>
								<td colspan="1">•</td>
								<td colspan="20"> '.$this->Xin_model->rupiah($pkwt[0]->allowance_komunikasi).' Uang Komunikasi diberikan sesuai dengan kehadiran 25 Hari Kerja dalam 1 bulan kerja.</td>
							</tr>
							...
							<tr>
								<td colspan="0"></td>
								<td colspan="1">•</td>
								<td colspan="20">Total Upah Harian yang didapatkan dengan perhitungan (Total Upah/Hari Kerja) '.$this->Xin_model->rupiah($sum_salary).' Hari Kerja sebesar. '.$this->Xin_model->rupiah($sum_salary/25).' / Hari.</td>
							</tr>
