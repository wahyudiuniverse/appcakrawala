...
class Pkwt108designer extends MY_Controller 
{
	...
	public function view() {
   	...
   	$pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
		...
		if($pkwt[0]->approve_hrd != null){
							...
							<tr>
								...
								<td colspan="18">PKWT ini berlangsung/berlaku selama <b>'.$waktukontrak.'</b> Bulan terhitung sejak <b>
													'.$this->Xin_model->tgl_indo($tglmulaipkwt).'</b> sampai dengan <b>
																		'.$this->Xin_model->tgl_indo($tglakhirpkwt).'</b> Selama <b>PIHAK KEDUA</b> menjadi Karyawan Kontrak</td>
							</tr>
				</table>
				...
				<div style="text-align: center; text-justify: inter-word;">
					<b>PASAL 3<br>TATA TERTIB WAKTU KERJA</b>
				</div>
				<br>
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							<tr>
								<td >3.4</td>
								<td colspan="20">Jadwal/Jam kerja yang dimaksud poin 3.3 adalah :</td>
								<td colspan="0"></td>
							</tr>
				...
				<div style="text-align: center; text-justify: inter-word;">
					<b>PASAL 6<br>BERAKHIRNYA PKWT</b>
				</div>
				<br>
...
<br>
				...
				<div style="text-align: center; text-justify: inter-word;">
					<b>PASAL 7<br>HUKUM YANG BERLAKU</b>
				</div>
				<br>
				...
				<div style="text-align: center; text-justify: inter-word;">
					<b>PASAL 8<br>ATURAN PEMELIHARAAN</b>
				</div>
				<br>
				...
				<div style="text-align: center; text-justify: inter-word;">
					<b>PASAL 9<br>KETENTUAN LAIN - LAIN</b>
				</div>
				<br>
