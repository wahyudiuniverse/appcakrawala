...
class Pkwt419 extends MY_Controller 
{
		...
		if($pkwt[0]->approve_hrd != null){
				...
				<table cellpadding="2" cellspacing="0" border="0" style="text-align: justify;">
							...
							<tr>
								<td ></td>
								<td colspan="0"></td>
								<td colspan="20"><br>•	Hari Senin – Sabtu 	7 Jam Kerja<br>•	Hari libur Minggu</td>
							</tr>

							<tr>
								<td ></td>
								<td colspan="20">Total jam Kerja dalam 7 (Tujuh) hari kalender (1 minggu) adalah 42 Jam Kerja atau sesuai dengan ketentuan klien/perusahaan.</td>
								<td colspan="0"></td>
							</tr>
