...
class Employee_pkwt_cancel extends MY_Controller {
	...
	public function pkwt_list_appcancel_null() {
	...
	public function pkwt_edit() {
		...
		$id = $this->uri->segment(4);
		// $id = '5700';
		$result = $this->Pkwt_model->read_pkwt_info_byuniq($id);
		if(is_null($result)){
			redirect('admin/');
		}
				...
				// $system = $this->Xin_model->read_setting_info(1);
					...
					$this->output($Return);
							...
							$datax = array(
								...
								'allow_kehadiran' 					=> $tunjangan_kehadiran,
						...
						$xresult = $this->Employees_model->update_record_bynip($datax,$nip_edit);
							...
							$data = array(
								...
								'allowance_kehadiran'						=> $tunjangan_kehadiran,
