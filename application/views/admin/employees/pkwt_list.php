...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/Employee_resign_apnae/');?>" data-link-data="<?php echo site_url('admin/Employee_resign_apnae/');?>" class="mb-3 nav-link hrpremium-link"> <span class="sw-icon ion ion-ios-paper"></span> Expired PKWT <?php echo '('.$count_appnae.')';?>
      </a> </li>
    <?php } ?>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="office_lokasi">Posisi/Jabatan<i class="hrpremium-asterisk">*</i></label>
            ...
            <div class="col-md-6">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="office_lokasi">Area/Penempatan<i class="hrpremium-asterisk">*</i></label>
                    <select class="form-control" name="office_lokasi" data-plugin="xin_select" data-placeholder="<?php echo $this->lang->line('xin_e_details_office_location');?>">
                      <option value="1">IN-HOUSE</option>
                      <option value="2">PROJECT</option>
                    </select>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="office_lokasi">Waktu Kontrak<i class="hrpremium-asterisk">*</i></label>
                    <select class="form-control" name="office_lokasi" data-plugin="xin_select" data-placeholder="<?php echo $this->lang->line('xin_e_details_office_location');?>">
                      <option value="1">IN-HOUSE</option>
                      <option value="2">PROJECT</option>
                    </select>
