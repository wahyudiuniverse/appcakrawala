                  ...
                  <div class="tab-pane fade show active" id="account-basic_info">
                    <div class="card-body media align-items-center">
                      ...
                      <div class="media-body ml-4"> 
                        ...
                        <a target="_blank" href="<?php echo site_url('admin/employees/download_profile/').$user_id;?>" hidden>
...
<!--marital status -->                          
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="email" class="control-label"><?php echo $this->lang->line('xin_employee_mstatus');?></label>
                  ...
                  <div class="tab-pane fade" id="account-qualification">
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_e_details_inst_name');?><i class="hrpremium-asterisk">*</i></label>
