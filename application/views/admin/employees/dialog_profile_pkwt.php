...
?>
  ...
  <?php echo form_open_multipart('admin/profile/updatepkwt/' . $idrequest, $attributes, $hidden); ?>
  ...
  <input class="form-control" name="nip" type="text" value="<?php echo $nip; ?>" hidden>
