...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <?php if(in_array('491',$role_resources_ids)) { ?>
    <li class="nav-item active"> <a href="<?php echo site_url('admin/employee_resign_history/');?>" data-link-data="<?php echo site_url('admin/Employee_resign_history/');?>" class="mb-3 nav-link hrpremium-link"> <span class="sw-icon ion ion-ios-paper"></span> History Paklaring
      </a> </li>
    <?php } ?>
  </ul>
</div>
...
<div class="card">
  <div class="card-header with-elements"> <span class="card-header-title mr-2">MONITORING >> <strong>PAKLARING</strong></span> </div>
  <div class="card-body">
