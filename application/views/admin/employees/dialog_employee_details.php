...
<div class="modal-body">
  <div class="row">
    ...
    <div class="col-md-7">
      <div class="form-group">
        <label for="work_email" class="control-label"><?php echo $this->lang->line('dashboard_email').'xx';?><i class="hrpremium-asterisk">*</i></label>
...
<div class="modal-body">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        <label for="title" class="control-label"><?php echo $this->lang->line('xin_e_details_dtitle');?><i class="hrpremium-asterisk">*</i></label>
...
<div class="modal-body">
  ...
  <div class="row">
    ...
    <div class="col-md-3">
      <div class="form-group">
        <label for="expiry_date" class="control-label"><?php echo $this->lang->line('xin_expiry_date');?><i class="hrpremium-asterisk">*</i></label>
...
<?php echo form_close(); ?> 
<!--<link rel="stylesheet" href="http://localhost/hrpremium_final/skin/hrpremium_assets/theme_assets/bower_components/select2/dist/css/select2.min.css">
<script src="http://localhost/hrpremium_final/skin/hrpremium_assets/vendor/select2/dist/js/select2.min.js"></script>--> 
<script type="text/javascript">
$(document).ready(function(){				
	$('[data-plugin="select_hrm"]').select2($(this).attr('data-options'));
	$('[data-plugin="select_hrm"]').select2({ width:'100%' });
...
<div class="modal-body">
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="form-group">
        <label for="from_date"><?php echo $this->lang->line('xin_e_details_frm_date');?><i class="hrpremium-asterisk">*</i></label>
      ...
      <div class="form-group">
        <label for="to_date"><?php echo $this->lang->line('xin_e_details_to_date');?><i class="hrpremium-asterisk">*</i></label>
...
<div class="modal-body">
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group">
        <label for="allowance_title"><?php echo $this->lang->line('dashboard_xin_title');?><i class="hrpremium-asterisk">*</i></label>
    ...
    <div class="col-md-2">
      <div class="form-group">
        <label for="allowance_amount" class="control-label"><?php echo $this->lang->line('xin_amount');?><i class="hrpremium-asterisk">*</i></label>
...
<div class="modal-body">
  <div class="row">
    ...
    <div class="col-md-2">
      <div class="form-group">
        <label for="amount" class="control-label"><?php echo $this->lang->line('xin_amount');?><i class="hrpremium-asterisk">*</i></label>
