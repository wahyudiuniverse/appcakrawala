...
-->
                  ...
                  <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-qualification"> 
                    <i class="lnr lnr-file-empty text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_e_details_qualification');?>
                  </a> 
...
<!--                   <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-contacts"> 
                    ...
                    <?php /*echo $this->lang->line('xin_employee_emergency_contacts');*/?>
                  </a>  -->



                  <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-baccount"> 
                    <i class="lnr lnr-apartment text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_e_details_baccount');?>
                  </a> 
...
-->
                  ...
                  <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-cpassword"> 
                    <i class="lnr lnr-lock text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_e_details_cpassword');?>
                  </a> 
                  ...
                  <div class="tab-pane fade show active" id="account-basic_info">
                    <div class="card-body media align-items-center">
                      ...
                      <div class="media-body ml-4"> 
                        ...
                        <!-- <a target="_blank" href="<?php //echo site_url('admin/employees/download_profile/').$user_id;?>">
                          <label class="btn btn-outline-primary"> <?php //echo $this->lang->line('xin_download_profile_title');?> 
                          </label>
                        </a> -->
...
<!--username to employeeid-->
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="username"><?php echo $this->lang->line('dashboard_empid');?><i class="hrpremium-asterisk"></i></label>
                              <input class="form-control" placeholder="<?php echo $this->lang->line('dashboard_empid');?>" name="username" type="text" value="<?php echo $employee_id;?>" <?php if($user_info[0]->user_role_id!=1) {echo 'disabled';}?>>
                            </div>
                          </div>
...
<!--ibu kandung-->
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="ibu_kandung" class="control-label"><?php echo $this->lang->line('xin_ibu_kandung');?><i class="hrpremium-asterisk">*</i></label>
                              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_ibu_kandung');?>" name="ibu_kandung" type="text" value="<?php echo $ibu_kandung;?>">
                            </div>
                          </div>
...
<!--dateofjoin-->                          
                          ...
                          <div class="col-md-4" >
                            <div class="form-group">
                              ...
                              <select class="form-control" name="status" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('dashboard_xin_status');?>" <?php if($user_info[0]->user_role_id==2) {echo 'disabled';}?>>
...
<!--dateofleaving-->                          
                          <div class="col-md-<?php echo $ncolmd;?>" hidden>
                            <div class="form-group">
...
<!--religion-->                          
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="ethnicity" class="control-label"><?php echo $this->lang->line('xin_ethnicity_type_title');?></label>
...
<!--gender-->                          
                          ...
                          <?php $marital_status_employee = $this->Xin_model->get_marital_status();?>
                          <?php $iemarital_id = $user_info[0]->marital_status;?>
<!--marital status -->                          
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="marital" class="control-label"><?php echo $this->lang->line('xin_employee_mstatus');?></label>
                              <select class="form-control" name="marital_status" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_employee_mstatus');?>">
                                <option value=""></option>
                                <?php 
                                foreach($marital_status_employee->result() as $imarital) 
                                  {
                                ?>
                                <option value="<?php echo $imarital->id_marital?>" 

                                <?php 
                                  if($imarital->id_marital==$marital_status):
                                ?> selected="selected"<?php endif;?>><?php echo $imarital->name_marital?></option>
                                <?php } ?>
                              </select>
                            </div>
                          </div>
...
<!--report to-->                          
                          <div class="col-md-4" hidden>
                            <div class="form-group">
                              ...
                              <select name="reports_to" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_reports_to');?>" <?php if($user_info[0]->user_role_id==2) {echo 'disabled';}?>>
                                <option value=""></option>
              ...
              ?>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <select class="form-control" name="role" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_employee_role');?>" <?php if($user_info[0]->user_role_id==2) {echo 'disabled';}?>>
                                <option value=""></option>
                  ...
                  <div class="tab-pane fade" id="account-contacts">
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="row">
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="relation"><?php echo $this->lang->line('xin_e_details_relation');?><i class="hrpremium-asterisk">*</i></label>
                        ...
                        <div class="col-md-7">
                          <div class="form-group">
                            <label for="work_email" class="control-label"><?php echo $this->lang->line('dashboard_email');?><i class="hrpremium-asterisk">*</i></label>
                      ...
                      <div class="row">
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="name" class="control-label"><?php echo $this->lang->line('xin_name');?><i class="hrpremium-asterisk">*</i></label>
                      ...
                      <div class="row">
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="work_phone"><?php echo $this->lang->line('xin_phone');?><i class="hrpremium-asterisk">*</i></label>
                            <div class="row">
                              <div class="col-md-8">
                  ...
                  <div class="tab-pane fade" id="account-experience">
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="company_name"><?php echo $this->lang->line('xin_company_name');?><i class="hrpremium-asterisk">*</i></label>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="post"><?php echo $this->lang->line('xin_e_details_post');?><i class="hrpremium-asterisk">*</i></label>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for="from_year" class="control-label"><?php echo $this->lang->line('xin_e_details_timeperiod');?><i class="hrpremium-asterisk">*</i></label>
                            <div class="row">
                              <div class="col-md-6">
              ...
              <div class="tab-pane fade" id="account-cpassword">
                    <div class="card-body pb-2">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="new_password"><?php echo $this->lang->line('xin_e_details_enpassword');?><i class="hrpremium-asterisk">*</i></label>
                            <input class="form-control" placeholder="<?php echo $this->lang->line('xin_e_details_enpassword');?>" name="new_password" type="password">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="new_password_confirm" class="control-label"><?php echo $this->lang->line('xin_e_details_ecnpassword');?><i class="hrpremium-asterisk">*</i></label>
