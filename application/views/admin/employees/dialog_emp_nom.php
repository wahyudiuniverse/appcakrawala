...
<?php $role_resources_ids = $this->Xin_model->user_role_resource(); ?>
  ...
  <div class="modal-header">
    ...
    <h4 class="modal-title" id="edit-modal-data"><i class="icon-pencil7"></i> HO - NOM >> Approval Karyawan Baru </h4>
  </div>
  ...
  <?php echo form_open_multipart('admin/employee_request_nom/update/'.$idrequest, $attributes, $hidden);?>
