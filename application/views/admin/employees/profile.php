              ...
              <div class="col-md-9">
                <div class="tab-content">
                              ...
                              <div class="col-md-4">
                                <div class="form-group">
                                  ...
                                  <select class="form-control" name="marital_status" data-plugin="select_hrm">
                                    <option value=""></option>
                                    <option value="1" <?php if ($marital_status == '1') : ?> selected <?php endif; ?>>Belum Menikah/Single</option>
                  ...
                  <div class="tab-pane fade" id="account-docpkwt">
                    ...
                    <div class="box">
                      <div class="card-header with-elements"> <span class="card-header-title mr-2"> <strong> <?php echo $this->lang->line('xin_list_all'); ?></strong> PKWT/TKHL dan addendum </span> </div>
                      <div class="card-body">
                        <div class="card-block">
