...
<script type="text/javascript">
  function lihat_eslip(secid, nip) {
    ...
    var html_text = '<a href="' + link_eslip + '"><button class="btn btn-lg btn-outline-primary ladda-button my-1 mx-1 col-12" data-style="expand-right">DOWNLOAD FILE ESLIP</button></a></br><object height="500px" data="' + link_eslip + '" type="application/pdf" width="100%"><p>Klik tombol diatas untuk download file.</p></object>';
...
<script type="text/javascript">
  function lihat_sk(secid, nip) {
    ...
    var html_text = '<a href="' + link_eslip + '"><button class="btn btn-lg btn-outline-primary ladda-button my-1 mx-1 col-12" data-style="expand-right">DOWNLOAD FILE SURAT KETERANGAN</button></a></br><object height="500px" data="' + link_eslip + '" type="application/pdf" width="100%"><p>Klik tombol diatas untuk download file.</p></object>';
    // var html_text = '<embed height="500px" class="col-md-12" type="application/pdf" src="' + link_eslip + '"></embed>';
    // var html_text = "<iframe src='" + link_eslip + "' style='zoom:1' frameborder='0' height='500' width='100%'></iframe>"
...
<script type="text/javascript">
  function open_kontrak(uniqueid, sub_project) {
    ...
    var html_text = '<a href="' + link_eslip + '"><button class="btn btn-lg btn-outline-primary ladda-button my-1 mx-1 col-12" data-style="expand-right">DOWNLOAD FILE KONTRAK</button></a></br><object height="500px" data="https://drive.google.com/viewerng/viewer?embedded=true&url=' + link_eslip + '" type="application/pdf" width="100%"><p>Klik tombol diatas untuk download file.</p></object>';
...
<script type="text/javascript">
  function open_addendum(id) {
    ...
    var html_text = '<a href="' + link_eslip + '"><button class="btn btn-lg btn-outline-primary ladda-button my-1 mx-1 col-12" data-style="expand-right">DOWNLOAD FILE ADDENDUM</button></a></br><object height="500px" data="' + link_eslip + '" type="application/pdf" width="100%"><p>Klik tombol diatas untuk download file.</p></object>';
    // var html_text = '<embed height="500px" class="col-md-12" type="application/pdf" src="' + link_eslip + '"></embed>';
    // var html_text = "<iframe src='" + link_eslip + "' style='zoom:1' frameborder='0' height='500' width='100%'></iframe>"
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        if (res['status'] == "200") {
          ...
          var html_text = '<a href="' + nama_file + '"><button class="btn btn-lg btn-outline-primary ladda-button my-1 mx-1 col-12" data-style="expand-right">DOWNLOAD FILE KONTRAK</button></a></br><object height="500px" data="' + nama_file + '" type="application/pdf" width="100%"><p>Klik tombol diatas untuk download file.</p></object>';
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        if (res['status'] == "200") {
          ...
          // var html_text = '<embed ' + height + ' class="col-md-12" type="' + atribut + '" src="' + nama_file + '"></embed>';
          var html_text = '<a href="' + nama_file + '"><button class="btn btn-lg btn-outline-primary ladda-button my-1 mx-1 col-12" data-style="expand-right">DOWNLOAD FILE ADDENDUM</button></a></br><object height="500px" data="' + nama_file + '" type="application/pdf" width="100%"><p>Klik tombol diatas untuk download file.</p></object>';
