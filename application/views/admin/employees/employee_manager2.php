												...
												<table class="table table-striped">
													<tbody>
														...
														<tr>
															...
															<td id="email_tabel">
																<?php echo $email; ?>
																<button onclick="open_email()" class="btn btn-sm btn-outline-primary mx-0">Send PIN via e-Mail</button>
															</td>
														</tr>
														<tr>
										...
										<?php if (($user[0]->user_role_id == "1") || ($user['0']->employee_id == "1") || ($user['0']->employee_id == "24535823") || ($user['0']->employee_id == "21300093")) { ?>
											<div class="form-row">
												...
												<div class="form-group col-md-2">
													...
													$t = time();
													// $ktp = '';
													if ($filename_ktp == "" || $filename_ktp == "0") {
														$tesfile1 = base_url('/uploads/document/ktp/') . "default.jpg";
														$file_ada = "";
													} else {
														if (strpos($filename_ktp, "https") !== false) {
															$tesfile1 = $filename_ktp . "?" . $t;
														} else {
															$tesfile1 = base_url('/uploads/document/ktp/') . $filename_ktp . "?" . $t;
														}
														$file_ada = "ada";
													}
												...
												<div class="form-group col-md-2">
													...
													//untuk menghindari cache image (saat ganti gambar, gambar masuk tapi tampilan masih mengambil cache iamge lama) 
													$t = time(); ?>
													<?php if ($filename_kk == "" || $filename_kk == "0") {
														$tesfile2 = base_url('/uploads/document/kk/') . "default.jpg";
														$file_ada = "";
													} else {
														$file_ada = "ada";
														// $kk = '';
														if (strpos($filename_kk, "https") !== false) {
															$tesfile2 = $filename_kk . "?" . $t;
														} else {
															$tesfile2 = base_url('/uploads/document/kk/') . $filename_kk . "?" . $t;
														}
													}
												...
												<div class="form-group col-md-2">
													...
													//untuk menghindari cache image (saat ganti gambar, gambar masuk tapi tampilan masih mengambil cache iamge lama) 
													$t = time(); ?>
													<?php if ($filename_npwp == "" || $filename_npwp == "0") {
														$tesfile3 = base_url('/uploads/document/npwp/') . "default.jpg";
														$file_ada = "";
													} else {
														$file_ada = "ada";
														// $file_npwp = '';
														if (strpos($filename_npwp, "https") !== false) {
															$tesfile3 = $filename_npwp . "?" . $t;
														} else {
															$tesfile3 = base_url('/uploads/document/npwp/') . $filename_npwp . "?" . $t;
														}
													}
												...
												<div class="form-group col-md-2">
													...
													//untuk menghindari cache image (saat ganti gambar, gambar masuk tapi tampilan masih mengambil cache iamge lama) 
													$t = time(); ?>
													<?php if ($filename_isd == "" || $filename_isd == "0") {
														$tesfile4 = base_url('/uploads/document/ijazah/') . "default.jpg";
														$file_ada = "";
													} else {
														$file_ada = "ada";
														// $ijazah = '';
														if (strpos($filename_isd, "https") !== false) {
															$tesfile4 = $filename_isd . "?" . $t;
														} else {
															$tesfile4 = base_url('/uploads/document/ijazah/') . $filename_isd . "?" . $t;
														}
													}
												...
												<div class="form-group col-md-2">
													...
													//untuk menghindari cache image (saat ganti gambar, gambar masuk tapi tampilan masih mengambil cache iamge lama) 
													$t = time(); ?>
													<?php if ($filename_cv == "" || $filename_cv == "0") {
														$tesfile5 = base_url('/uploads/document/cv/') . "default.jpg";
														$file_ada = "";
													} else {
														$file_ada = "ada";
														// $civi = '';
														if (strpos($filename_cv, "https") !== false) {
															$tesfile5 = $filename_cv . "?" . $t;
														} else {
															$tesfile5 = base_url('/uploads/document/cv/') . $filename_cv . "?" . $t;
														}
													}
												...
												<div class="form-group col-md-2">
													...
													//untuk menghindari cache image (saat ganti gambar, gambar masuk tapi tampilan masih mengambil cache iamge lama) 
													$t = time(); ?>
													<?php if ($filename_skck == "" || $filename_skck == "0") {
														$tesfile6 = base_url('/uploads/document/skck/') . "default.jpg";
														$file_ada = "";
													} else {
														$file_ada = "ada";
														// $skck = '';
														if (strpos($filename_skck, "https") !== false) {
															$tesfile6 = $filename_skck . "?" . $t;
														} else {
															$tesfile6 = base_url('/uploads/document/skck/') . $filename_skck . "?" . $t;
														}
													}
...
<script type="text/javascript">
	document.getElementById("button_send_pin").onclick = function(e) {
		...
		var pesan_whatsapp = '*C.I.S -> Employees Registration.*%0a%0a' +
			...
			'*INFO HRD di Nomor Whatsapp: 088211158907* %0a' +
