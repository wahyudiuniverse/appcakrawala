...
<script type="text/javascript">
  function lihat_eslip(secid, nip) {
    ...
    var html_text = '<object height="500px" data="' + link_eslip + '" type="application/pdf" width="100%"><p>Browser anda tidak support PDF.</br><a href="' + link_eslip + '"><img class="col-12" src="<?= base_url() ?>assets/icon/klik_download.png"></a></p></object>';
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        if (res['status'] == "200") {
          ...
          var html_text = '<object height="500px" data="' + nama_file + '" type="application/pdf" width="100%"><p>Browser anda tidak support PDF.</br><a href="' + nama_file + '"><img class="col-12" src="<?= base_url() ?>assets/icon/klik_download.png"></a></p></object>';
