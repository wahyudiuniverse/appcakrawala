  ...
  <div class="sw-container tab-content">
    ...
    ?>
      ...
      <div class="card-body">
          ...
          <h6>
            <a href="<?php echo base_url();?>uploads/csv/TEMPLATE E-SALTAB CIS (15112023).xlsx" class="btn btn-primary"> 
          ...
          <?php echo form_open_multipart('admin/importexcel/import_esaltab', $attributes, $hidden);?>
