  ...
  <div class="card <?php echo $get_animate;?>">
    <div class="form-row">
      ...
      <div class="btn btn-secondary" data-toggle="tooltip" data-state="primary" data-placement="top" style="padding: inherit;">
                  <div>
                    <a class="dropdown-item back" href="<?php echo site_url().'admin/importexcel/importratecard/';?>" data-status="1" data-user-id="<?php echo $uploadid;?>" style="color: azure;">SELESAI</a>
                  </div>
      ...
      <table class="datatables-demo table table-striped table-bordered" id="xin_table" style="table-layout: fixed;">
        <thead>
          <tr>
            ...
            <th style="width: 50px;">Jumlah MPP</th>
