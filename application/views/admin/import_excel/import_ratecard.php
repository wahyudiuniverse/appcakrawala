      ...
      <div class="modal-header bg-danger">
        <h5 class="modal-title" id="requestOpenModalLabel">
          <div class="judul-modal">
            ...
            <font color="#FFFFFF"> Import Periode Ratecard </font>
...
?>
  ...
  <div class="card border-blue">
    ...
    <div class="card-header with-elements">
      <div class="col-md-6">
        <span class="card-header-title mr-2">
          <strong>QUOTATION | RATECARD | </strong>IMPORT FILE
        </span>
      </div>
    ...
    <div class="card-body border-bottom-blue ">
      ...
      <div class="form-row">
        ...
        <div class="col-md-4">
          <div class="form-group">
            <!-- input periode -->
            <label class="form-label">Tanggal (Kosong)<font color="#FF0000">*</font></label>
            <input type="text" class="form-control date" name="periode_salary" id="periode_salary" placeholder="Tanggal (kosong)" required>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="form-row">
            <div class="col-md-6">
              <div class="form-group">
                <!-- input periode -->
                <label class="form-label">Periode Kontrak Dari:<font color="#FF0000">*</font></label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <!-- input periode -->
                <label class="form-label">Kontrak Sampai:<font color="#FF0000">*</font></label>
...
<div class="card <?php echo $get_animate; ?>">
  <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong>LIST BATCH |</strong> History RATECARD (Belum Release)</span> </div>
  <div class="card-body">
