...
<ul class="sidenav-inner py-1">
	...
	if (
		...
		|| in_array('1501', $role_resources_ids)
		|| in_array('1502', $role_resources_ids)
	) {
	?>
		<li class="<?php if (!empty($arr_mod['ratecard2_open'])) echo $arr_mod['ratecard2_open']; ?> sidenav-item">
			<a href="#" class="sidenav-link sidenav-toggle">
				<i class="sidenav-icon ion ion-logo-buffer"></i>
				<div>RATECARD</div>
			</a>
			...
			<ul class="sidenav-menu">
				...
				?>
					<li class="sidenav-item <?php if (!empty($arr_mod['import_ratecard2_active'])) echo $arr_mod['import_ratecard2_active']; ?>">
						<a class="sidenav-link" href="<?php echo site_url('admin/importexcel/import_ratecard2'); ?>"> Import Ratecard
						</a>
					</li>
				<?php
				}
				...
				?>
					<li class="sidenav-item <?php if (!empty($arr_mod['manage_ratecard2_active'])) echo $arr_mod['manage_ratecard2_active']; ?>">
						<a class="sidenav-link" href="<?php echo site_url('admin/importexcel/manage_ratecard'); ?>"> Manage Ratecard
						</a>
					</li>
				<?php
				}
	...
	?>
		<li class="<?php if (!empty($arr_mod['saltab_open'])) echo $arr_mod['saltab_open']; ?> sidenav-item">
			...
			<ul class="sidenav-menu">
				...
				?>
					<li class="sidenav-item <?php if (!empty($arr_mod['import_absensi_active'])) echo $arr_mod['konfig_download_esaltab_active']; ?>">
						<a class="sidenav-link" href="<?php echo site_url('admin/importexcel/import_absensi'); ?>"> Import Data Absensi
						</a>
					</li>
				<?php
				}
				...
				?>
					<li class="sidenav-item <?php if (!empty($arr_mod['import_esaltab_active'])) echo $arr_mod['import_esaltab_active']; ?>">
						<a class="sidenav-link" href="<?php echo site_url('admin/importexcel/importesaltab'); ?>"> SALTAB Temp
						</a>
					</li>
				<?php
				}
