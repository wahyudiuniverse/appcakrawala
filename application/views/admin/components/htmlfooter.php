...
<!-- <script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/js/jquery.min.js"></script> -->

<!-- jQuery UI 1.11.4 -->
<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/jquery-ui/jquery-ui.min.js"></script>
<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/popper/popper.js"></script>
<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/js/bootstrap.js"></script>
<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/js/sidenav.js"></script>

<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/js/dropdown-hover.js"></script>
<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/bootstrap-menu/bootstrap-menu.js"></script>

<!-- JS & CSS library of MultiSelect plugin -->
<script src="<?= base_url('vendor/jquery-magicsuggest/magicsuggest.js') ?>" type="text/javascript"></script>


<!-- Picker-->
<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/moment/moment.js"></script>
<!--<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/bootstrap-datepicker/bootstrap-datepicker.js"></script>
<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/bootstrap-daterangepicker/bootstrap-daterangepicker.js"></script>-->
...
<!-- Libs -->
<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>
...
<?php } ?>
<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/datatables/datatables.js"></script>
<?php if ($this->router->fetch_class() == 'reports' || $this->router->fetch_method() == 'payment_history' || $this->router->fetch_method() == 'accounts_ledger') { ?>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/datatable_export/dataTables.buttons.min.js"></script>

	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/datatable_export/jszip.min.js"></script>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/datatable_export/pdfmake.min.js"></script>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/datatable_export/vfs_fonts.js"></script>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/datatable_export/buttons.html5.min.js"></script>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/datatable_export/buttons.print.min.js"></script>
	<link rel="stylesheet" href="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/datatable_export/buttons.dataTables.min.css">
<?php } ?>
<?php if ($this->router->fetch_class() == 'settings') { ?>
	<link rel="stylesheet" href="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/bootstrap-duallistbox/bootstrap-duallistbox.css">
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/bootstrap-duallistbox/bootstrap-duallistbox.js"></script>
...
<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/js/ui_tooltips.js"></script>
<?php if (($this->router->fetch_class() == 'employees' && $this->router->fetch_method() == 'detail') || $this->router->fetch_class() == 'import' || $this->router->fetch_class() == 'profile' || $this->router->fetch_method() == 'view_all') { ?>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/smartwizard/smartwizard.js"></script>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/js/forms_wizard.js"></script>
<?php } ?>
<link rel="stylesheet" href="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/ladda/ladda.css">
<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/spin/spin.js"></script>
<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/ladda/ladda.js"></script>
...
<?php if ($this->router->fetch_class() == 'employees' || $this->router->fetch_class() == 'dashboard' || $this->router->fetch_method() == 'accounting_dashboard' || $this->router->fetch_method() == 'attendance_dashboard' || $this->router->fetch_class() == 'project') { ?>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/chartjs/chartjs.js"></script>
<?php } ?>
<?php if ($this->router->fetch_class() == 'events' || $this->router->fetch_class() == 'meetings') { ?>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/minicolors/minicolors.js"></script>
<?php } ?>
<script type="text/javascript">
...
<?php if ($this->router->fetch_method() == 'tasks') { ?>
	...
	<?php } ?>
<?php } ?>
<script type="text/javascript" src="<?php echo base_url() . 'skin/hrpremium_vendor/hrpremium_scripts/' . $path_url . '.js'; ?>"></script>
<?php if ($this->router->fetch_class() == 'dashboard') { ?>
	<?php if ($user[0]->user_role_id != 1) : ?>
		<?php if ($system[0]->is_ssl_available == 'yes') { ?>
			<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/hrpremium_scripts/user/set_clocking_ssl.js"></script>
		<?php } else { ?>
			<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/hrpremium_scripts/user/set_clocking_non_ssl.js"></script>
		<?php } ?>
	<?php endif; ?>
<?php } ?>
<?php if ($this->router->fetch_class() == 'roles') { ?>
	<script type="text/javascript" src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/kendo/kendo.all.min.js"></script>
	<?php $this->load->view('admin/roles/role_values'); ?>
<?php } ?>
<!-- UI SideNav -->
<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/js/pages_contacts.js"></script>
<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/js/demo.js"></script>
<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/js/dropdown-hover.js"></script>
<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/js/ui_navbar.js"></script>
<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/js/ui_dropdowns.js"></script>
...
<?php if ($this->router->fetch_method() == 'accounting_dashboard') { ?>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/hrpremium_scripts/hrpremium_charts/hrpremium_expense_deposit.js"></script>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/knob/knob.js"></script>
	<script type="text/javascript">
		$(function() {
			/* jQueryKnob */
			$(".knob").knob({});
...
<?php if ($this->router->fetch_method() == 'attendance_dashboard') { ?>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/hrpremium_scripts/hrpremium_charts/employee_working_status.js"></script>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/hrpremium_scripts/hrpremium_charts/hrpremium_overtime_request.js"></script>
<?php } ?>
<?php if ($this->router->fetch_method() == 'projects_dashboard') { ?>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/hrpremium_scripts/hrpremium_charts/hrpremium_projects.js"></script>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/hrpremium_scripts/hrpremium_charts/hrpremium_tasks.js"></script>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/hrpremium_scripts/hrpremium_charts/hrpremium_clients_leads.js"></script>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/flot/flot.js"></script>

<?php } ?>
<?php if ($this->router->fetch_class() == 'reports') { ?>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/js/pages_file-manager.js"></script>
<?php } ?>
<?php if ($this->router->fetch_class() == 'chat') { ?>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/js/pages_chat.js"></script>
<?php } ?>
...
<?php if ($this->router->fetch_class() == 'calendar' || $this->router->fetch_class() == 'timesheet' || $this->router->fetch_class() == 'dashboard' || $this->router->fetch_method() == 'timecalendar' || $this->router->fetch_method() == 'projects_calendar' || $this->router->fetch_method() == 'tasks_calendar' || $this->router->fetch_method() == 'quote_calendar' || $this->router->fetch_method() == 'invoice_calendar' || $this->router->fetch_method() == 'projects_dashboard' || $this->router->fetch_method() == 'accounting_dashboard' || $this->router->fetch_method() == 'calendar') { ?>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/fullcalendar/dist/fullcalendar.js"></script>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/libs/fullcalendar/dist/scheduler.min.js"></script>
<?php } ?>
<?php if ($this->router->fetch_method() == 'tasks_scrum_board' || $this->router->fetch_method() == 'projects_scrum_board') { ?>
	<script src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/dragula/dragula.js"></script>
<?php } ?>
...
<?php if ($this->router->fetch_class() == 'goal_tracking' || $this->router->fetch_method() == 'task_details' || $this->router->fetch_class() == 'project' || $this->router->fetch_method() == 'project_details' || $this->router->fetch_class() == 'quoted_projects') { ?>
	<script type="text/javascript" src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/ion.rangeSlider/js/ion-rangeSlider/ion.rangeSlider.min.js"></script>
<?php } ?>
...
<?php if ($this->router->fetch_class() == 'timesheet' && $this->router->fetch_method() == 'index') { ?>
	<?php $this->load->view('admin/components/vendors/monthly_hrpremium_calendar'); ?>
<?php } ?>
...
<?php if ($this->router->fetch_class() == 'invoices' || $this->router->fetch_class() == 'quotes' && $this->router->fetch_method() == 'view') { ?>
	<script type="text/javascript" src="<?php echo base_url(); ?>skin/hrpremium_vendor/assets/vendor/printThis.js"></script>
	<script type="text/javascript">
		$(document).ready(function() {
