          ...
          <div class="row">
            <div class="col-md-8">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <label for="tunjangan_trans_rental" class="control-label">17) Tunj. Transport & Rental<i class="hrpremium-asterisk">*</i></label>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="0" name="tunjangan_pelatihan" type="text" value="<?php echo $this->Xin_model->rupiah_titik($allow_training); ?>" style="text-align: right;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="0" name="tunjangan_grooming" type="text" value="<?php echo $this->Xin_model->rupiah_titik($allow_grooming); ?>" style="text-align: right;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="0" name="tunjangan_kehadiran" type="text" value="<?php echo $this->Xin_model->rupiah_titik($allow_kehadiran);?>" style="text-align: right;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="0" name="tunjangan_kinerja" type="text" value="<?php echo $this->Xin_model->rupiah_titik($allow_kinerja);?>" style="text-align: right;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="0" name="tunjangan_disiplin" type="text" value="<?php echo $this->Xin_model->rupiah_titik($allow_disiplin); ?>" style="text-align: right;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="0" name="tunjangan_others" type="text" value="<?php echo $this->Xin_model->rupiah_titik($allow_others); ?>" style="text-align: right;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                  </div>
                </div>
