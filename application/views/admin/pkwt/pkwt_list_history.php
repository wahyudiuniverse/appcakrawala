...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/Employee_pkwt_apnom/');?>" data-link-data="<?php echo site_url('admin/Employee_pkwt_apnom/');?>" class="mb-3 nav-link hrpremium-link"> <span class="sw-icon ion ion-ios-paper"></span> Approve HRD
      <?php echo '('.$count_apphrd.')';?></a> </li>
    <?php } ?>
    
    <?php if(in_array('377',$role_resources_ids)) { ?>
    <li class="nav-item active"> <a href="<?php echo site_url('admin/Employee_pkwt_history/');?>" data-link-data="<?php echo site_url('admin/Employee_pkwt_history/');?>" class="mb-3 nav-link hrpremium-link"> <span class="sw-icon ion ion-ios-paper"></span> History PKWT
      </a> </li>
    <?php } ?>
  </ul>
</div>
