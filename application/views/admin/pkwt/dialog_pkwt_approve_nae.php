...
<?php $role_resources_ids = $this->Xin_model->user_role_resource(); ?>
  ...
  <?php echo form_open_multipart('admin/Employee_pkwt_apnae/update/'.$contract_id, $attributes, $hidden);?>
...
<!-- APPROVAL -->
 ...
 <hr style="height:1px;border-width:0;color:gray;background-color:#e3e3e3; margin: auto;">
  ...
  <div class="modal-footer">
    ...
    <button type="submit" class="btn btn-primary save">APPROVE NAE</button>
    <?php } ?>
  </div>
