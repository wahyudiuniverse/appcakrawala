...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active"> <a href="<?php echo site_url('admin/employee_pkwt_apnae');?>" data-link-data="<?php echo site_url('admin/Employee_pkwt_apnae/');?>" class="mb-3 nav-link hrpremium-link"> <span class="sw-icon ion ion-ios-paper"></span>PKWT - NAE <?php echo '('.$count_appnae.')';?>
      </a> </li>
    <?php } ?>
