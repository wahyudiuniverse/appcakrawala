...
<?php $role_resources_ids = $this->Xin_model->user_role_resource(); ?>
  ...
  <div class="modal-header">
    ...
    <h4 class="modal-title" id="edit-modal-data"><i class="icon-pencil7"></i> MONITORING PKWT DETAIL</h4>
  </div>
  ...
  <?php echo form_open_multipart('admin/employee_request/update/'.$contract_id, $attributes, $hidden);?>
