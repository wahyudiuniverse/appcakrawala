		...
		jQuery("#treeview_m1").kendoTreeView({
			...
			dataSource: [
					...
					items: [{
						...
						// MY PROFILE
						{
							...
							items: [{
								...
								},
								{
									...
									value: "133",
									check: "<?php if (isset($_GET['role_id'])) {
												if (in_array('133', $role_resources_ids)) : echo 'checked';
												else : echo '';
												endif;
											} ?>"
								}
						...
						// MY PKWT
						{
							...
							items: [{
									...
									value: "137",
									check: "<?php if (isset($_GET['role_id'])) {
												if (in_array('137', $role_resources_ids)) : echo 'checked';
												else : echo '';
												endif;
											} ?>"
								},
								{
									...
									value: "138",
									check: "<?php if (isset($_GET['role_id'])) {
												if (in_array('138', $role_resources_ids)) : echo 'checked';
												else : echo '';
												endif;
											} ?>"
								}
						...
						// MY ESLIP
						{
							...
							items: [{
								...
								value: "140",
								check: "<?php if (isset($_GET['role_id'])) {
											if (in_array('140', $role_resources_ids)) : echo 'checked';
											else : echo '';
											endif;
										} ?>"
							}]
				...
				// CUSTOMER
				{
					...
					check: "<?php if (isset($_GET['role_id'])) {
								if (in_array('69', $role_resources_ids)) : echo 'checked';
								else : echo '';
								endif;
							} ?>",
					add_info: "<?php echo $this->lang->line('xin_create_edit_view_delete'); ?>",
					...
					items: [{
						...
						},
						{
							...
							value: "70",
							check: "<?php if (isset($_GET['role_id'])) {
										if (in_array('70', $role_resources_ids)) : echo 'checked';
										else : echo '';
										endif;
									} ?>"
						},
						{
							...
							value: "100",
							check: "<?php if (isset($_GET['role_id'])) {
										if (in_array('100', $role_resources_ids)) : echo 'checked';
										else : echo '';
										endif;
									} ?>"
						},
						{
							...
							value: "101",
							check: "<?php if (isset($_GET['role_id'])) {
										if (in_array('101', $role_resources_ids)) : echo 'checked';
										else : echo '';
										endif;
									} ?>"
						},
						{
							...
							value: "102",
							check: "<?php if (isset($_GET['role_id'])) {
										if (in_array('102', $role_resources_ids)) : echo 'checked';
										else : echo '';
										endif;
									} ?>"
						}
				...
				//USER CALLPLAN
				{
					...
					check: "<?php if (isset($_GET['role_id'])) {
								if (in_array('105', $role_resources_ids)) : echo 'checked';
								else : echo '';
								endif;
							} ?>",
					add_info: "<?php echo $this->lang->line('xin_create_edit_view_delete'); ?>",
					...
					items: [{
						...
						},
						{
							...
							value: "123",
							check: "<?php if (isset($_GET['role_id'])) {
										if (in_array('123', $role_resources_ids)) : echo 'checked';
										else : echo '';
										endif;
									} ?>"
						},
						{
							...
							value: "124",
							check: "<?php if (isset($_GET['role_id'])) {
										if (in_array('124', $role_resources_ids)) : echo 'checked';
										else : echo '';
										endif;
									} ?>"
						},
						{
							...
							value: "125",
							check: "<?php if (isset($_GET['role_id'])) {
										if (in_array('125', $role_resources_ids)) : echo 'checked';
										else : echo '';
										endif;
									} ?>"
						}
		...
		jQuery("#treeview_m2").kendoTreeView({
			...
			dataSource: [
...

				{
					...
					value: "33",
					check: "<?php if (isset($_GET['role_id'])) {
								if (in_array('33', $role_resources_ids)) : echo 'checked';
								else : echo '';
								endif;
							} ?>"
				},
