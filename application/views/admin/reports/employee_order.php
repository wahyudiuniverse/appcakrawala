...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/reports/report_resume/');?>" data-link-data="<?php echo site_url('admin/reports/report_resume/');?>" class="mb-3 nav-link hrpremium-link"> <span class="sw-icon fa fa-database"></span> Resume Order
      </a> </li>
    <?php } ?>  
    <?php if(in_array('114',$role_resources_ids)) { ?>
    <li class="nav-item active"> <a href="<?php echo site_url('admin/reports/report_order/');?>" data-link-data="<?php echo site_url('admin/reports/report_order/');?>" class="mb-3 nav-link hrpremium-link"> <span class="sw-icon ion ion-ios-paper"></span> Detail Order</a> </li>
    <?php } ?>
          ...
          <table class="datatables-demo table table-striped table-bordered" id="xin_table">
            <thead>
              ...
              <tr>
                ...
                <th style="width:100px;">Nama Toko</th>
                <th style="width:100px;">Alamat Lengkap</th>
                ...
                <th style="width:40px;">Harga Stuan</th>
