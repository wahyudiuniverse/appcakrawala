      ...
      <div class="card-body">
        <div class="box-datatable table-responsive">
          <table class="datatables-demo table table-striped table-bordered" id="xin_table" style="width:100%;table-layout: fixed;">
            <thead>
              <tr>
                <th style="width: 20px;"><?php echo $this->lang->line('dashboard_xin_status');?></th>
                <th style="width: 100px;"><?php echo $this->lang->line('xin_no_dokumen');?></th>
                <th style="width: 60px;"><?php echo $this->lang->line('xin_nip');?></th>
                <th style="width: 120px;"><?php echo $this->lang->line('xin_employees_full_name');?></th>
                <th style="width: 60px;"><?php echo $this->lang->line('xin_e_details_dtype');?></th>
                <th style="width: 60px;">Tanggal Terbit</th>
