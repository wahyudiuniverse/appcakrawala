...
<div class="row">
    <div class="col-md-12 <?php echo $get_animate;?>">
        ...
        <?php $attributes = array('name' => 'employee_cs', 'id' => 'employee_cs', 'autocomplete' => 'off', 'class' => 'add form-hrm');?>
		<?php $hidden = array('euser_id' => $session['user_id']);?>
        <?php echo form_open('admin/customerservices/cs_list', $attributes, $hidden);?>
      <?php
        $data = array(
          'name'  => 'user_id',
          'id'    => 'user_id',
