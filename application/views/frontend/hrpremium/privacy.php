...
<p class="privacy-policy-p">
    ...
    Jl Andara Raya No 12 Depok,
    JAWA BARAT
    16514,
    Indonesia,
    email: itcare@spcakrawala.co.id,
    phone: +6285174123434

    on the collection,
    use and disclosure of your information that we collect
    when you use our website ( https://traxes.id ).
...
<ol class="privacy-policy-ol">
    ...
    <li>
        ...
        <p class="privacy-policy-p">
            ...
            <a href="https://traxes.id">Cookie Policy.</a>
        </p>
    </li>
    ...
    <li>
        ...
        <p class="privacy-policy-p">
            When you use Google Service, we may collect and process information about your actual location we use various technologies to datermine location. Including IP Address, GPS, and Other sensors that may for example, provider Google with information on nearby devices Wi-Fi access points and cell towers
            When we have location information, we use it to tailor our services for you and others, like helping you to check-in and find local events or offers in your area or tell your friends that you are nerby
        </p>
    </li>
...
<p class="privacy-policy-p">
    Privacy Policy collaborate with  LEGAL Division at PT. Siprama Cakrawala.
</p>
</div>
<!-- Container / End -->