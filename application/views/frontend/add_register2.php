...
<script type="text/javascript">
	document.getElementById("dokumen_next_button").onclick = function(e) {
		...
		var project = "<?php print($register['project']); ?>";
		...
		var skck = "<?php print($register['skck']); ?>";
		var pesan = "";

		// alert("<?php print($register['project']); ?>");
		...
		//cek skck untuk project tertentu
		if (project == "94") {
			if (skck == "" || skck == "0" || (!skck.includes("/"))) {
				pesan = pesan.concat("Dokumen SKCK masih kosong\n");
			}
		}
