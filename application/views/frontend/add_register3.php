...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 ml-4 text-gray-800"><br><h2>REGISTRASI KARYAWAN TKHL 2025</h2><h5> CAKRAWALA GROUP</h5><br></h1>
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link <?php echo $dsb['nik'];
                                ?><?php echo $p == '' || $p == 'nik' ? 'active' : ''; ?>" href="<?php echo base_url('registrasi_tkhl/addRegister/nik') ?>/<?php echo $karyawan; ?>">NIK</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link <?php echo $dsb['perusahaan'];
                                ?> <?php echo $p == 'perusahaan' ? 'active' : ''; ?>" href="<?php echo base_url('registrasi_tkhl/addRegister/perusahaan') ?>/<?php echo $karyawan; ?>">Perusahaan</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link <?php echo $dsb['project'];
                                ?> <?php echo $p == 'project' ? 'active' : ''; ?>" href="<?php echo base_url('registrasi_tkhl/addRegister/project') ?>/<?php echo $karyawan; ?>">Project</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link <?php echo $dsb['data_diri'];
                                ?> <?php echo $p == 'data_diri' ? 'active' : ''; ?>" href="<?php echo base_url('registrasi_tkhl/addRegister/data_diri') ?>/<?php echo $karyawan; ?>">Data Diri</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link <?php echo $dsb['kontak_darurat'];
                                ?> <?php echo $p == 'kontak_darurat' ? 'active' : ''; ?>" href="<?php echo base_url('registrasi_tkhl/addRegister/kontak_darurat') ?>/<?php echo $karyawan; ?>">Kontak Darurat</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link <?php echo $dsb['dokumen'];
                                ?> <?php echo $p == 'dokumen' ? 'active' : ''; ?>" href="<?php echo base_url('registrasi_tkhl/addRegister/dokumen') ?>/<?php echo $karyawan; ?>">Dokumen</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link <?php echo $dsb['review'];
                                ?> <?php echo $p == 'review' ? 'active' : ''; ?>" href="<?php echo base_url('registrasi_tkhl/addRegister/review') ?>/<?php echo $karyawan; ?>">Review</a>
        </li>
    </ul>
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <?php if ($p == '' || $p == 'nik') { ?>
            ...
            <!-- <form action='<?php base_url() . '/registrasi_tkhl/addRegisterPost' ?>' method='post'> -->
            <?php echo form_open_multipart('/registrasi_tkhl/addRegisterPost');
            ?>
        ...
        <!-- Tab Perusahaan -->
        <?php if ($p == 'perusahaan') { ?>
            <!-- <form action='<?php base_url() . '/registrasi_tkhl/addRegister' ?>' method='post'> -->
            <?php echo form_open_multipart('/registrasi_tkhl/addRegisterPost');
            ?>
        ...
        <?php if ($p == 'dokumen') { ?>
                    ...
                    <div class="card-body border-bottom-blue ">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                <!-- <form action='<?php base_url() . '/registrasi_tkhl/addRegister' ?>' method='post' enctype="multipart/form-data"> -->
                                <?php echo form_open_multipart('/registrasi_tkhl/addRegisterPost');
                                ?>
                                <?php
            ...
            <button id="dokumen_next_button_tkhl" class="btn btn-primary btn-sm btn-lg btn-block">NEXT</button>
        <?php } ?>
